...
const scriptPath = resolve(projectRoot, 'scripts/quality/site-check.js');
...
describe('Site Infrastructure Checker', () => {
  ...
  describe('Valid Site Fixtures', () => {
    ...
    it('passes site with complete infrastructure', () => {
      const result = runSiteCheck('tests/unit/fixtures/valid/site-check/');
  ...
  describe('Invalid Site Fixtures', () => {
    ...
    it('fails site missing required files', () => {
      const result = runSiteCheck('tests/unit/fixtures/invalid/site-check/');
  ...
  describe('Strict Mode', () => {
    ...
    it('treats warnings as errors with --strict flag', () => {
      ...
      const result = runSiteCheck('--strict tests/unit/fixtures/invalid/site-check/');
      assert.strictEqual(result.success, false);
    });
