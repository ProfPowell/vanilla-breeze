export default [
  ...
  { name: 'adr-wc', href: '/docs/elements/web-components/adr-wc/', desc: 'Architecture Decision Record component for documenting technical decisions' },
  { name: 'brand-mark', href: '/docs/elements/web-components/brand-mark/', desc: 'Logo display with dark mode, compact variant, and stacked layout support' },
  ...
  { name: 'gradient-builder', href: '/docs/elements/web-components/gradient-builder/', desc: 'Interactive CSS gradient builder with color stops, angle control, and oklab interpolation' },
