...
// ─── Sparkle particles ──────────────────────────────────────────────────────
// Floating sparkle/star particles that drift around an element.

const SPARKLE_CHARS = ['✦', '✧', '⋆', '♡', '☆']
const SPARKLE_COLORS = [
  'oklch(75% 0.18 350)',  // pink
  'oklch(70% 0.15 290)',  // lavender
  'oklch(75% 0.12 60)',   // peach
  'oklch(70% 0.12 220)',  // sky
  'oklch(65% 0.15 180)',  // mint
]

function initSparkleParticles(el) {
...
function destroySparkleParticles(el) {
