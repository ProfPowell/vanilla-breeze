var ce=window.matchMedia("(prefers-reduced-motion: reduce)");var It=new Map;function x(c,t,e={}){let s=e.priority??10,r={impl:t,bundle:e.bundle,contract:e.contract,priority:s},i=It.get(c);if(customElements.get(c)){if(!i||i.priority>=s){i&&i.priority===s&&i.impl!==t&&console.warn(`[VB Bundle] Tag <${c}> already registered by "${i.bundle}" (priority ${i.priority}). Skipping "${e.bundle}".`);return}console.warn(`[VB Bundle] Tag <${c}> defined by "${i.bundle}" cannot be replaced (customElements.define is permanent). "${e.bundle}" has higher priority but arrived late.`);return}if(i&&i.priority>=s){i.priority===s&&console.warn(`[VB Bundle] Tag <${c}> already registered by "${i.bundle}". Skipping "${e.bundle}" (first wins at equal priority).`);return}It.set(c,r),customElements.define(c,t)}var C=class extends HTMLElement{#e=[];#t;connectedCallback(){this.hasAttribute("data-upgraded")||this.setup()!==!1&&(this.setAttribute("data-upgraded",""),queueMicrotask(()=>{this.dispatchEvent(new CustomEvent(`${this.localName}:upgraded`,{bubbles:!0}))}))}disconnectedCallback(){for(let t of this.#e)t();this.#e=[],this.removeAttribute("data-upgraded"),this.teardown()}listen(t,e,s,r){t.addEventListener(e,s,r),this.#e.push(()=>t.removeEventListener(e,s,r))}setup(){}teardown(){}setState(t,e){this.#t||(this.#t=this.attachInternals());let s=this.#t.states;try{e?s.add(t):s.delete(t)}catch{let r=`--${t}`;e?s.add(r):s.delete(r)}}_adoptInternals(t){this.#t||(this.#t=t)}};var tt=class c extends C{#e=null;#t=null;#s=!1;#i=null;setup(){this.setAttribute("role","list"),this.#s=window.matchMedia("(prefers-reduced-motion: reduce)").matches,this.#o(),this.#n(),this.#f(),this.#r()}teardown(){this.#e&&(this.#e.remove(),this.#e=null),c.#C?.source===this&&(c.#C=null)}get draggableChildren(){return[...this.querySelectorAll(':scope > [draggable="true"]')]}get group(){return this.getAttribute("group")||null}get orientation(){return this.getAttribute("orientation")||"vertical"}get sortedOrder(){return this.draggableChildren.map(t=>t.dataset.id)}#r(){for(let t of this.draggableChildren)t.getAttribute("role")||t.setAttribute("role","listitem"),t.hasAttribute("tabindex")||t.setAttribute("tabindex","0"),t.hasAttribute("aria-grabbed")||t.setAttribute("aria-grabbed","false")}#o(){this.#e=document.createElement("div"),this.#e.setAttribute("role","status"),this.#e.setAttribute("aria-live","polite"),this.#e.setAttribute("aria-atomic","true"),this.#e.style.cssText="position:absolute;width:1px;height:1px;overflow:hidden;clip:rect(0,0,0,0);",this.prepend(this.#e)}#a(t){let e=this.#e;e&&(e.textContent="",requestAnimationFrame(()=>{e.textContent=t}))}#n(){this.listen(this,"pointerdown",t=>{this.#i=t.target}),this.listen(this,"dragstart",this.#l.bind(this)),this.listen(this,"dragover",this.#c.bind(this)),this.listen(this,"dragleave",this.#p.bind(this)),this.listen(this,"drop",this.#d.bind(this)),this.listen(this,"dragend",this.#h.bind(this))}#l(t){let e=t.target.closest('[draggable="true"]');if(!e||e.parentElement!==this||this.hasAttribute("disabled"))return;let s=e.querySelector("[data-drag-handle]");if(s&&!s.contains(this.#i)){t.preventDefault();return}e.setAttribute("data-dragging",""),t.dataTransfer.effectAllowed="move",t.dataTransfer.setData("text/plain",e.dataset.id||""),t.dataTransfer.setData("application/x-drag-surface-group",this.group||"");let r=this.#g(e);c.#C={item:e,source:this,originalIndex:r},this.dispatchEvent(new CustomEvent("drag-surface:reorder-start",{bubbles:!0}))}#c(t){let e=c.#C;if(!e||(this.group||e.source.group)&&this.group!==e.source.group)return;t.preventDefault(),t.dataTransfer.dropEffect="move",this.setAttribute("data-drag-over","");let s=this.orientation==="horizontal"?t.clientX:t.clientY;this.#A(s)}#p(t){t.relatedTarget&&!this.contains(t.relatedTarget)&&(this.removeAttribute("data-drag-over"),this.#_())}#d(t){t.preventDefault(),this.removeAttribute("data-drag-over"),this.#_();let e=c.#C;if(!e)return;let{item:s,source:r,originalIndex:i}=e,a=this.orientation==="horizontal"?t.clientX:t.clientY,o=this.#k(a);if(r===this){this.#v(s,o),this.#m();let n=this.#g(s);this.#u(s),this.dispatchEvent(new CustomEvent("drag-surface:reorder",{bubbles:!0,detail:{item:s,itemId:s.dataset.id,oldIndex:i,newIndex:n,order:this.sortedOrder}}))}else this.#v(s,o),this.#m(),r.#m(),this.#u(s),this.dispatchEvent(new CustomEvent("drag-surface:transfer",{bubbles:!0,detail:{item:s,itemId:s.dataset.id,fromSurface:r,toSurface:this,newIndex:this.#g(s),fromOrder:r.sortedOrder,toOrder:this.sortedOrder}}))}#h(){let t=c.#C;t?.item&&t.item.removeAttribute("data-dragging"),this.removeAttribute("data-drag-over"),this.#_(),c.#C=null,this.dispatchEvent(new CustomEvent("drag-surface:reorder-end",{bubbles:!0}))}#f(){this.listen(this,"keydown",this.#x.bind(this))}#x(t){let e=t.target.closest('[draggable="true"]');if(!e||e.parentElement!==this||this.hasAttribute("disabled"))return;let s=e.getAttribute("aria-grabbed")==="true",r=this.orientation==="horizontal",i=r?"ArrowLeft":"ArrowUp",a=r?"ArrowRight":"ArrowDown";if(t.key===" "||t.key==="Enter"){if(t.preventDefault(),s){e.setAttribute("aria-grabbed","false"),this.removeAttribute("data-reorder-mode"),this.#m(),this.#u(e);let d=this.#g(e),l=this.draggableChildren;this.#a(`${this.#w(e)}, dropped at position ${d+1} of ${l.length}`),this.dispatchEvent(new CustomEvent("drag-surface:reorder",{bubbles:!0,detail:{item:e,itemId:e.dataset.id,oldIndex:this.#t,newIndex:d,order:this.sortedOrder}})),this.dispatchEvent(new CustomEvent("drag-surface:reorder-end",{bubbles:!0})),this.#t=null}else{this.#t=this.#g(e),e.setAttribute("aria-grabbed","true"),this.setAttribute("data-reorder-mode","");let d=this.draggableChildren;this.#a(`${this.#w(e)}, grabbed. Position ${this.#t+1} of ${d.length}. Use arrow keys to move, Enter to drop, Escape to cancel.`),this.dispatchEvent(new CustomEvent("drag-surface:reorder-start",{bubbles:!0}))}return}if(!s&&(t.key===i||t.key===a)){t.preventDefault();let d=this.draggableChildren,l=d.indexOf(e),h=t.key===i?Math.max(0,l-1):Math.min(d.length-1,l+1);h!==l&&d[h].focus();return}if(s&&(t.key===i||t.key===a)){t.preventDefault();let d=this.draggableChildren,l=d.indexOf(e),h=t.key===i?Math.max(0,l-1):Math.min(d.length-1,l+1);h!==l&&(this.#v(e,h),e.focus(),this.#a(`Position ${h+1} of ${d.length}`));return}let o=r?"ArrowUp":"ArrowLeft",n=r?"ArrowDown":"ArrowRight";if(s&&(t.key===o||t.key===n)){if(t.preventDefault(),!this.group)return;let d=t.key===n?1:-1,l=this.#b(d);if(!l)return;l.appendChild(e),l.#m(),this.#m(),l.#u(e),e.focus();let h=l.getAttribute("aria-label")||"next surface";l.#a(`Moved to ${h}`),l.dispatchEvent(new CustomEvent("drag-surface:transfer",{bubbles:!0,detail:{item:e,itemId:e.dataset.id,fromSurface:this,toSurface:l,newIndex:l.draggableChildren.indexOf(e),fromOrder:this.sortedOrder,toOrder:l.sortedOrder}})),this.removeAttribute("data-reorder-mode"),l.setAttribute("data-reorder-mode",""),this.#t=null;return}if(s&&t.key==="Escape"){t.preventDefault(),e.setAttribute("aria-grabbed","false"),this.removeAttribute("data-reorder-mode"),this.#t!=null&&(this.#v(e,this.#t),e.focus()),this.#a("Reorder cancelled"),this.dispatchEvent(new CustomEvent("drag-surface:reorder-end",{bubbles:!0})),this.#t=null;return}!s&&t.key==="Escape"&&(t.preventDefault(),e.blur())}#u(t){t.setAttribute("data-just-dropped",""),t.addEventListener("animationend",()=>{t.removeAttribute("data-just-dropped")},{once:!0}),setTimeout(()=>t.removeAttribute("data-just-dropped"),500)}#b(t){if(!this.group)return null;let e=[...document.querySelectorAll(`drag-surface[group="${this.group}"]`)];if(e.length<2)return null;e.sort((i,a)=>{let o=i.getBoundingClientRect(),n=a.getBoundingClientRect();return o.left-n.left||o.top-n.top});let s=e.indexOf(this);return e[s+t]||null}#w(t){return t.dataset.id||t.textContent.trim().slice(0,40)}#g(t){return this.draggableChildren.indexOf(t)}#v(t,e){let r=this.draggableChildren.filter(i=>i!==t)[e]||null;r?this.insertBefore(t,r):this.appendChild(t)}#m(){this.draggableChildren.forEach((t,e)=>{t.dataset.sortOrder=String(e+1)})}#k(t){let e=this.orientation==="horizontal",s=this.draggableChildren.filter(r=>!r.hasAttribute("data-dragging"));for(let r=0;r<s.length;r++){let i=s[r].getBoundingClientRect(),a=e?i.left+i.width/2:i.top+i.height/2;if(t<a)return r}return s.length}#A(t){this.#_();let e=this.orientation==="horizontal",s=this.draggableChildren.filter(r=>!r.hasAttribute("data-dragging"));for(let r=0;r<s.length;r++){let i=s[r].getBoundingClientRect(),a=e?i.left+i.width/2:i.top+i.height/2;if(t<a){s[r].setAttribute("data-drop-target","before");return}}s.length>0&&s[s.length-1].setAttribute("data-drop-target","after")}#_(){for(let t of this.querySelectorAll("[data-drop-target]"))t.removeAttribute("data-drop-target")}static#C=null};x("drag-surface",tt);var Tt=`
  :host {
    display: block;
...
`;function f(c){return String(c).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function L(c){return c.split(" ").map(t=>t[0]).join("").toUpperCase().slice(0,2)}function z(c){let t=0;for(let s=0;s<c.length;s++)t=c.charCodeAt(s)+((t<<5)-t);return`hsl(${(t%360+360)%360}, 65%, 55%)`}function A(c){return`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">${c}</svg>`}var k={user:'<path d="M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/>',pencil:'<path d="M21.174 6.812a1 1 0 0 0-3.986-3.987L3.842 16.174a2 2 0 0 0-.5.83l-1.321 4.352a.5.5 0 0 0 .623.622l4.353-1.32a2 2 0 0 0 .83-.497z"/><path d="m15 5 4 4"/>',check:'<path d="M20 6 9 17l-5-5"/>',target:'<circle cx="12" cy="12" r="10"/><circle cx="12" cy="12" r="6"/><circle cx="12" cy="12" r="2"/>',alertTriangle:'<path d="m21.73 18-8-14a2 2 0 0 0-3.48 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3"/><path d="M12 9v4"/><path d="M12 17h.01"/>',messageCircle:'<path d="M2.992 16.342a2 2 0 0 1 .094 1.167l-1.065 3.29a1 1 0 0 0 1.236 1.168l3.413-.998a2 2 0 0 1 1.099.092 10 10 0 1 0-4.777-4.719"/>',lightbulb:'<path d="M15 14c.2-1 .7-1.7 1.5-2.5 1-.9 1.5-2.2 1.5-3.5A6 6 0 0 0 6 8c0 1 .2 2.2 1.5 3.5.7.7 1.3 1.5 1.5 2.5"/><path d="M9 18h6"/><path d="M10 22h4"/>',wrench:'<path d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.106-3.105c.32-.322.863-.22.983.218a6 6 0 0 1-8.259 7.057l-7.91 7.91a1 1 0 0 1-2.999-3l7.91-7.91a6 6 0 0 1 7.057-8.259c.438.12.54.662.219.984z"/>',heart:'<path d="M2 9.5a5.5 5.5 0 0 1 9.591-3.676.56.56 0 0 0 .818 0A5.49 5.49 0 0 1 22 9.5c0 2.29-1.5 4-3 5.5l-5.492 5.313a2 2 0 0 1-3 .019L5 15c-1.5-1.5-3-3.2-3-5.5"/>',mapPin:'<path d="M20 10c0 4.993-5.539 10.193-7.399 11.799a1 1 0 0 1-1.202 0C9.539 20.193 4 14.993 4 10a8 8 0 0 1 16 0"/><circle cx="12" cy="10" r="3"/>',checkCircle:'<path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><path d="m9 11 3 3L22 4"/>',x:'<path d="M18 6 6 18"/><path d="m6 6 12 12"/>',download:'<path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" x2="12" y1="15" y2="3"/>',send:'<path d="M14.536 21.686a.5.5 0 0 0 .937-.024l6.5-19a.496.496 0 0 0-.635-.635l-19 6.5a.5.5 0 0 0-.024.937l7.93 3.18a2 2 0 0 1 1.112 1.11z"/><path d="m21.854 2.147-10.94 10.939"/>'},et={says:{label:"Says",icon:k.messageCircle,color:"#3b82f6"},thinks:{label:"Thinks",icon:k.lightbulb,color:"#8b5cf6"},does:{label:"Does",icon:k.wrench,color:"#f59e0b"},feels:{label:"Feels",icon:k.heart,color:"#ef4444"}},T={delighted:{emoji:"\u{1F604}",score:.95,color:"#16a34a"},satisfied:{emoji:"\u{1F60A}",score:.8,color:"#22c55e"},hopeful:{emoji:"\u{1F642}",score:.68,color:"#84cc16"},curious:{emoji:"\u{1F914}",score:.55,color:"#eab308"},neutral:{emoji:"\u{1F610}",score:.5,color:"#94a3b8"},uncertain:{emoji:"\u{1F615}",score:.4,color:"#f97316"},confused:{emoji:"\u{1F635}",score:.3,color:"#fb923c"},frustrated:{emoji:"\u{1F624}",score:.18,color:"#ef4444"},angry:{emoji:"\u{1F620}",score:.05,color:"#dc2626"}};var Ot="https://cdn.jsdelivr.net/gh/faker-js/assets-person-portrait",H=[32,64,128,256,512];function Ut(c){let t=0;for(let e=0;e<c.length;e++)t=c.charCodeAt(e)+((t<<5)-t);return t}function Vt(c){let t=H[0],e=Math.abs(c-t);for(let s=1;s<H.length;s++){let r=Math.abs(c-H[s]);r<e&&(t=H[s],e=r)}return t}function Nt(c,t=128){let e=Ut(String(c)),s=(e%100+100)%100,r=(e>>>16&1)===0?"female":"male",i=Vt(t);return`${Ot}/${r}/${i}/${s}.jpg`}function st(c){let t=0;for(let e=0;e<c.length;e++)t=c.charCodeAt(e)+((t<<5)-t);return t}var Yt=["Sarah Chen","Marcus Johnson","Aisha Patel","James O'Brien","Yuki Tanaka","Elena Rodriguez","David Kim","Fatima Al-Hassan","Lucas Silva","Priya Sharma","Noah Williams","Mei Lin","Carlos Mendez","Amara Osei","Henrik Larsson","Zara Ahmed"],Wt=["Product Manager","UX Designer","Frontend Developer","Data Analyst","Marketing Lead","QA Engineer","DevOps Lead","Content Strategist","Startup Founder","IT Director","Customer Success Lead","Research Scientist"],Xt=["San Francisco, CA","Austin, TX","London, UK","Toronto, CA","Berlin, DE","Tokyo, JP","Sydney, AU","S\xE3o Paulo, BR"],Qt=["I need tools that help me stay organized without slowing me down.","The dashboard is where I live \u2014 it has to be fast and reliable.","I want to understand the data, not fight the interface.","If it takes more than two clicks, I\u2019ll find another way.","Collaboration shouldn\u2019t mean endless notification noise.","I just want it to work the way I expect it to.","Give me the big picture first, then let me drill into details.","Accessibility isn\u2019t a nice-to-have \u2014 it\u2019s how I use the web."],Kt=["Streamline daily workflows","Reduce context-switching","Stay aligned with the team","Make data-driven decisions quickly","Ship features on a predictable cadence","Automate repetitive tasks","Improve onboarding experience","Keep documentation up to date"],Gt=["Too many disconnected tools","Slow page loads break focus","Unclear ownership of tasks","Settings that reset unexpectedly","Notifications that bury important updates","Poor mobile experience","Inconsistent design across features","No offline support"],Jt=["Checks dashboards every morning","Prefers keyboard shortcuts over mouse","Skims docs, reads deeply only when stuck","Shares screenshots in Slack","Batches email to twice a day","Tests features in incognito first","Bookmarks frequently used reports","Uses dark mode exclusively"],rt=class extends HTMLElement{static get observedAttributes(){return["role","age","location","avatar","compact","src","data-list-stories","id"]}#e=new Map;#t=null;constructor(){super(),this.attachShadow({mode:"open"})}relatedStories(){if(!this.id)return[];let t=this.getRootNode(),e=t.querySelectorAll?t:document;return Array.from(e.querySelectorAll(`user-story[persona-id="${Zt(this.id)}"]`))}#s(){for(let t of[...this.children]){let e=t.getAttribute("slot");e&&!this.getAttribute(e)&&this.#e.set(e,t.textContent.trim())}}_resolve(t){return this.getAttribute(t)||this.#e.get(t)||""}get data(){return{name:this.personaName,role:this.personaRole||void 0,age:this.age||void 0,location:this.location||void 0,avatar:this.avatar||void 0,quote:this.quote||void 0,bio:this.#e.get("bio")||void 0,goals:this.#e.get("goals")||void 0,frustrations:this.#e.get("frustrations")||void 0,behaviors:this.#e.get("behaviors")||void 0}}set data(t){!t||typeof t!="object"||(this._applyData(t),this.shadowRoot&&this.#n(),this.dispatchEvent(new CustomEvent("user-persona:data-changed",{detail:{data:this.data,source:"property"},bubbles:!0,composed:!0})))}_applyData(t){for(let e of["role","age","location","avatar"])t[e]&&this.setAttribute(e,t[e]);if(t.name&&!this.querySelector('[slot="name"]')){let e=document.createElement("h2");e.slot="name",e.textContent=t.name,this.appendChild(e)}if(t.quote&&!this.querySelector('[slot="quote"]')){let e=document.createElement("p");e.slot="quote",e.textContent=t.quote,this.appendChild(e)}for(let e of["bio","goals","frustrations","behaviors"])t[e]&&this.#e.set(e,t[e])}async _loadSrc(t){if(t)try{let e=await fetch(t);if(!e.ok)throw new Error(`HTTP ${e.status}`);let s=await e.json();this._applyData(s),this.#n()}catch(e){console.warn(`[user-persona] Failed to load src="${t}":`,e)}}connectedCallback(){this.#s(),this.hasAttribute("data-mock")?this.#a():this.hasAttribute("src")&&this._loadSrc(this.getAttribute("src")),this.#n(),this.#i(),this.setAttribute("data-upgraded",""),this.dispatchEvent(new CustomEvent("persona-ready",{bubbles:!0,composed:!0,detail:{name:this.personaName,role:this.personaRole}}))}disconnectedCallback(){this.removeAttribute("data-upgraded"),this.#t?.disconnect(),this.#t=null}#i(){if(!this.hasAttribute("data-list-stories")||!this.id){this.#t?.disconnect(),this.#t=null;return}this.#t||(this.#t=new MutationObserver(()=>this.#r()),this.#t.observe(document.body,{childList:!0,subtree:!0,attributes:!0,attributeFilter:["persona-id"]}))}#r(){if(!this.shadowRoot)return;let t=this.shadowRoot.querySelector("[data-stories-section]");t&&(t.outerHTML=this.#o())}#o(){if(!this.hasAttribute("data-list-stories")||!this.id)return"";let t=this.relatedStories();return`
    ...
    `}attributeChangedCallback(t,e,s){if(!(e===s||!this.shadowRoot)){if(t==="src"&&this.isConnected){this._loadSrc(s);return}(t==="data-list-stories"||t==="id")&&this.#i(),this.#n()}}get personaName(){return this.querySelector('[slot="name"]')?.textContent?.trim()||this.#e.get("name")||"Unnamed Persona"}get personaRole(){return this.getAttribute("role")||""}get age(){return this.getAttribute("age")||""}get location(){return this.getAttribute("location")||""}get avatar(){return this.getAttribute("avatar")||""}get quote(){return this.querySelector('[slot="quote"]')?.textContent?.trim()||this.#e.get("quote")||""}get compact(){return this.hasAttribute("compact")}#a(){let t=this.dataset.seed||this.dataset.mock||String(Date.now()),e=i=>i[(st(t+i.length)%i.length+i.length)%i.length],s=(i,a)=>{let o=[];for(let n=0;n<a;n++)o.push(i[(st(t+n+i.length)%i.length+i.length)%i.length]);return[...new Set(o)]};if(!this.querySelector('[slot="name"]')){let i=document.createElement("h2");i.slot="name",i.textContent=e(Yt),this.appendChild(i)}if(this.getAttribute("role")||this.setAttribute("role",e(Wt)),this.getAttribute("age")||this.setAttribute("age",String(25+(st(t)%30+30)%30)),this.getAttribute("location")||this.setAttribute("location",e(Xt)),!this.getAttribute("avatar")){let i=this.querySelector('[slot="name"]')?.textContent?.trim()||"Persona";this.setAttribute("avatar",Nt(i,256))}if(!this.querySelector('[slot="quote"]')){let i=document.createElement("p");i.slot="quote",i.textContent=e(Qt),this.appendChild(i)}let r=(i,a)=>{if(this.querySelector(`[slot="${i}"]`))return;let o=document.createElement("ul");o.setAttribute("slot",i);for(let n of a){let d=document.createElement("li");d.textContent=n,o.appendChild(d)}this.appendChild(o)};r("goals",s(Kt,3)),r("frustrations",s(Gt,3)),r("behaviors",s(Jt,3))}#n(){let t=this.personaName,e=this.personaRole,s=this.age,r=this.location,i=this.avatar,a=this.quote,o=z(t),n=i?`background:url(${f(i)}) center/cover`:`background:${o}`;this.shadowRoot.innerHTML=`
      <style>${Tt}</style>
    ...
    `}};function Zt(c){return typeof CSS<"u"&&CSS.escape?CSS.escape(String(c)):String(c).replace(/["\\]/g,"\\$&")}x("user-persona",rt);var it=`
:host {
...
`;var at=class c extends HTMLElement{static get observedAttributes(){return["persona-id","priority","points","status","epic","story-id","compact","detail","src"]}static PRIORITIES={critical:{label:"Critical",color:"#dc2626",bg:"rgba(220, 38, 38, 0.1)"},high:{label:"High",color:"#ea580c",bg:"rgba(234, 88, 12, 0.1)"},medium:{label:"Medium",color:"#ca8a04",bg:"rgba(202, 138, 4, 0.1)"},low:{label:"Low",color:"#16a34a",bg:"rgba(22, 163, 74, 0.1)"}};static STATUSES={backlog:{label:"Backlog",color:"#6b7280",bg:"rgba(107, 114, 128, 0.1)"},"to-do":{label:"To Do",color:"#3b82f6",bg:"rgba(59, 130, 246, 0.1)"},"in-progress":{label:"In Progress",color:"#8b5cf6",bg:"rgba(139, 92, 246, 0.1)"},review:{label:"Review",color:"#f59e0b",bg:"rgba(245, 158, 11, 0.1)"},done:{label:"Done",color:"#22c55e",bg:"rgba(34, 197, 94, 0.1)"}};#e=new Map;constructor(){super(),this.attachShadow({mode:"open"})}#t(){for(let t of[...this.children]){let e=t.getAttribute("slot");e&&this.#e.set(e,t.textContent.trim())}}_resolve(t){return this.getAttribute(t)||this.#e.get(t)||""}get data(){return{storyId:this.storyId||void 0,personaId:this.personaId||void 0,priority:this.priority,status:this.status,points:this.points||void 0,epic:this.epic||void 0,detail:this.getAttribute("detail")||void 0,persona:this.persona||void 0,action:this.action||void 0,benefit:this.benefit||void 0,title:this.storyTitle||void 0}}set data(t){!t||typeof t!="object"||(this._applyData(t),this.#t(),this.shadowRoot&&this.#s(),this.dispatchEvent(new CustomEvent("user-story:data-changed",{detail:{data:this.data,source:"property"},bubbles:!0,composed:!0})))}_applyData(t){for(let[e,s]of[["storyId","story-id"],["personaId","persona-id"],["priority","priority"],["status","status"],["points","points"],["epic","epic"],["detail","detail"]])t[e]!=null&&this.setAttribute(s,String(t[e]));if(t.persona&&!this.querySelector('[slot="persona"]')){let e=document.createElement("span");e.slot="persona",e.textContent=t.persona,this.appendChild(e)}if(t.action&&!this.querySelector('[slot="action"]')){let e=document.createElement("span");e.slot="action",e.textContent=t.action,this.appendChild(e)}if(t.benefit&&!this.querySelector('[slot="benefit"]')){let e=document.createElement("span");e.slot="benefit",e.textContent=t.benefit,this.appendChild(e)}if(t.title&&!this.querySelector('[slot="title"]')){let e=document.createElement("h3");e.slot="title",e.textContent=t.title,this.appendChild(e)}for(let e of["acceptance-criteria","tasks","notes"]){let s=e==="acceptance-criteria"?"acceptanceCriteria":e;if(t[s]&&!this.querySelector(`[slot="${e}"]`))if(Array.isArray(t[s])){let r=document.createElement("ul");r.slot=e;for(let i of t[s]){let a=document.createElement("li");a.textContent=i,r.appendChild(a)}this.appendChild(r)}else{let r=document.createElement("p");r.slot=e,r.textContent=t[s],this.appendChild(r)}}}async _loadSrc(t){if(t)try{let e=await fetch(t);if(!e.ok)throw new Error(`HTTP ${e.status}`);let s=await e.json();this._applyData(s),this.#t(),this.#s()}catch(e){console.warn(`[user-story] Failed to load src="${t}":`,e)}}connectedCallback(){this.#t(),this.storyId&&!this.id&&(this.id=this.storyId),this.hasAttribute("src")&&this._loadSrc(this.getAttribute("src")),this.#s(),this.setAttribute("data-upgraded","")}disconnectedCallback(){this.removeAttribute("data-upgraded")}attributeChangedCallback(t,e,s){e!==s&&this.shadowRoot&&(t==="src"&&this.isConnected?this._loadSrc(s):this.#s())}get persona(){return this.querySelector('[slot="persona"]')?.textContent?.trim()||this.#e.get("persona")||"user"}get personaId(){return this.getAttribute("persona-id")||""}get action(){return this.querySelector('[slot="action"]')?.textContent?.trim()||this.#e.get("action")||""}get benefit(){return this.querySelector('[slot="benefit"]')?.textContent?.trim()||this.#e.get("benefit")||""}get priority(){return this.getAttribute("priority")||"medium"}get points(){return this.getAttribute("points")||""}get status(){return this.getAttribute("status")||"backlog"}get epic(){return this.getAttribute("epic")||""}get storyId(){return this.getAttribute("story-id")||""}get storyTitle(){return this.querySelector('[slot="title"]')?.textContent?.trim()||this.#e.get("title")||""}get _minimalLabel(){if(this.storyTitle)return this.storyTitle;let t=this.action;return t.length>40?t.slice(0,40)+"\u2026":t}get compact(){return this.hasAttribute("compact")}get _detailLevel(){return this.getAttribute("detail")?this.getAttribute("detail"):this.hasAttribute("compact")?"compact":"full"}updateStatus(t){c.STATUSES[t]&&(this.setAttribute("status",t),this.dispatchEvent(new CustomEvent("status-changed",{detail:{status:t,storyId:this.storyId},bubbles:!0,composed:!0})))}updatePriority(t){c.PRIORITIES[t]&&(this.setAttribute("priority",t),this.dispatchEvent(new CustomEvent("priority-changed",{detail:{priority:t,storyId:this.storyId},bubbles:!0,composed:!0})))}showDetail(){let t=`story-dialog-${this.storyId||this.id||"detail"}`,e=document.getElementById(t);e||(e=document.createElement("dialog"),e.id=t,e.setAttribute("data-size","l"),document.body.appendChild(e));let s=document.createElement("form");s.method="dialog";let r=document.createElement("header"),i=document.createElement("h3");i.textContent=this.storyTitle||this.storyId||"Story Detail";let a=document.createElement("button");a.type="submit",a.setAttribute("aria-label","Close"),a.textContent="\xD7",r.appendChild(i),r.appendChild(a);let o=document.createElement("section"),n=document.createElement("user-story");for(let l of this.getAttributeNames())l==="detail"||l==="compact"||l==="data-upgraded"||l==="draggable"||l==="data-id"||l==="data-quadrant"||n.setAttribute(l,this.getAttribute(l));let d=[...this.children].some(l=>l.getAttribute("slot")&&l.tagName!=="DIALOG");n.setAttribute("detail",d?"full":"compact"),n.removeAttribute("id");for(let l of[...this.children])l.tagName!=="DIALOG"&&n.appendChild(l.cloneNode(!0));o.appendChild(n),s.appendChild(r),s.appendChild(o),e.innerHTML="",e.appendChild(s),e.addEventListener("close",()=>{e.innerHTML=""},{once:!0}),e.showModal()}#s(){let t=c.PRIORITIES[this.priority]||c.PRIORITIES.medium,e=c.STATUSES[this.status]||c.STATUSES.backlog,s=this._detailLevel,r=this.storyId?`User story: ${f(this.storyId)}`:"User story";if(s==="minimal"){this.shadowRoot.innerHTML=`
      ...
      `,s==="compact"&&this.shadowRoot.querySelectorAll(".section").forEach(a=>{let o=a.querySelector("slot");o&&o.assignedNodes().length===0&&a.setAttribute("data-empty","")});this.dispatchEvent(new CustomEvent("story-ready",{detail:{id:this.storyId,persona:this.persona,action:this.action,benefit:this.benefit,priority:this.priority,status:this.status,points:this.points},bubbles:!0,composed:!0}))}};x("user-story",at);var O=`
  :host {
    display: block;
...
`;var te=[{key:"actions",label:"Actions"},{key:"thoughts",label:"Thoughts"},{key:"touchpoints",label:"Touchpoints"},{key:"painPoints",label:"Pain Points"},{key:"opportunities",label:"Opportunities"}],ot=class extends HTMLElement{static get observedAttributes(){return["src","persona","persona-id","story-ids","compact"]}#e=new Map;constructor(){super(),this.attachShadow({mode:"open"}),this.__phases=null}get phases(){return this.__phases}set phases(t){this.__phases!==t&&(this.__phases=t,this.isConnected&&this._render(),this.dispatchEvent(new CustomEvent("user-journey:phases-changed",{detail:{phases:t,source:"property"},bubbles:!0,composed:!0})))}get data(){return{persona:this.getAttribute("persona")||void 0,personaId:this.getAttribute("persona-id")||void 0,title:this.querySelector('[slot="title"]')?.textContent?.trim()||void 0,summary:this.querySelector('[slot="summary"]')?.textContent?.trim()||void 0,phases:this.__phases||void 0}}set data(t){if(!(!t||typeof t!="object")){if(t.persona&&this.setAttribute("persona",String(t.persona)),t.personaId&&this.setAttribute("persona-id",String(t.personaId)),t.title&&!this.querySelector('[slot="title"]')){let e=document.createElement("h2");e.slot="title",e.textContent=t.title,this.appendChild(e)}if(t.summary&&!this.querySelector('[slot="summary"]')){let e=document.createElement("p");e.slot="summary",e.textContent=t.summary,this.appendChild(e)}t.phases!=null&&(this.__phases=t.phases),this.isConnected&&this._render(),this.dispatchEvent(new CustomEvent("user-journey:data-changed",{detail:{data:this.data,source:"property"},bubbles:!0,composed:!0}))}}#t(){for(let t of this.children){let e=t.getAttribute("slot");e&&this.#e.set(e,t.textContent.trim())}}_resolve(t){return this.getAttribute(t)||this.#e.get(t)||""}connectedCallback(){this.#t(),this.setAttribute("data-upgraded",""),this.hasAttribute("src")?this._loadSrc(this.getAttribute("src")):this._render()}disconnectedCallback(){this.removeAttribute("data-upgraded")}attributeChangedCallback(t){this.isConnected&&(t==="src"?this._loadSrc(this.getAttribute("src")):this._render())}async _loadSrc(t){if(t){this.shadowRoot.innerHTML=`<style>${O}</style><div class="state-msg">Loading\u2026</div>`;try{let e=await fetch(t);if(!e.ok)throw new Error(`HTTP ${e.status}`);let s=await e.json();if(s.persona&&this.setAttribute("persona",s.persona),s.personaId&&this.setAttribute("persona-id",s.personaId),s.title&&!this.querySelector('[slot="title"]')){let r=document.createElement("h2");r.slot="title",r.textContent=s.title,this.appendChild(r)}if(s.summary&&!this.querySelector('[slot="summary"]')){let r=document.createElement("p");r.slot="summary",r.textContent=s.summary,this.appendChild(r)}this.__phases=s.phases||[],this._render()}catch(e){this.shadowRoot.innerHTML=`<style>${O}</style><div class="state-msg state-msg--error">Could not load journey: ${f(e.message)}</div>`}}}_render(){let t=this._resolve("persona")||"",e=this._resolve("persona-id")||"",s=(this.getAttribute("story-ids")||"").split(",").map(n=>n.trim()).filter(Boolean),r=this.hasAttribute("compact"),i=this.__phases,a=!!this.querySelector('[slot="summary"]')||this.#e.has("summary"),o=this.querySelector('[slot="title"]')?.textContent?.trim()||this.#e.get("title")||"";this.shadowRoot.innerHTML=`<style>${O}</style>
      ...
      <div class="journey__curve" aria-hidden="true">
        <svg viewBox="0 0 1000 100" preserveAspectRatio="none" class="curve-svg">
          ...
          ${h.map(({x:p,y:g,ph:v})=>{let w=T[v.emotion]||T.neutral;return`<circle cx="${p}" cy="${g}" r="5" class="dot" style="fill:${w.color}"/>`}).join("")}
        </svg>
        ...
        </th>`}).join(""),s=te.map(({key:r,label:i})=>{let a=t.map(o=>{let n=o[r]||[];return n.length?`<td class="data-cell data-cell--${r.toLowerCase()}">
          ${n.map(d=>`<p>${f(d)}</p>`).join("")}
      ...
      </div>`}_label(t){return t.replace(/^(activity|persona|journey|story|user)-/,"").replace(/-/g," ").replace(/\b\w/g,e=>e.toUpperCase())}};x("user-journey",ot);var U=`
  :host {
    display: block;
    font-family: var(--_font-sans);
    line-height: 1.6;
...
`;var nt=["says","thinks","does","feels"],lt=class extends HTMLElement{static get observedAttributes(){return["persona","persona-id","src","editable","compact"]}#e=new Map;constructor(){super(),this.attachShadow({mode:"open"}),this.__quadrants=null,this.__goals=null,this.__painPoints=null,this._editingQuadrants=new Set}get quadrants(){return this.__quadrants}set quadrants(t){this.__quadrants=t,this.isConnected&&this._render()}get goals(){return this.__goals}set goals(t){this.__goals=t,this.isConnected&&this._render()}get painPoints(){return this.__painPoints}set painPoints(t){this.__painPoints=t,this.isConnected&&this._render()}#t(){for(let t of this.children){let e=t.getAttribute("slot");e&&this.#e.set(e,t.textContent.trim())}}_resolve(t){return this.getAttribute(t)||this.#e.get(t)||""}connectedCallback(){this.#t(),this.setAttribute("data-upgraded",""),this.hasAttribute("src")?this._loadSrc(this.getAttribute("src")):this._render()}disconnectedCallback(){this.removeAttribute("data-upgraded")}attributeChangedCallback(t){this.isConnected&&(t==="src"?this._loadSrc(this.getAttribute("src")):this._render())}get data(){let t=this.querySelector('[slot="title"]'),e=this.querySelector('[slot="summary"]');return{persona:this.getAttribute("persona")||void 0,personaId:this.getAttribute("persona-id")||void 0,title:t?.textContent?.trim()||void 0,summary:e?.textContent?.trim()||void 0,quadrants:this.__quadrants||void 0,goals:this.__goals||void 0,painPoints:this.__painPoints||void 0}}set data(t){if(!(!t||typeof t!="object")){if(t.persona&&this.setAttribute("persona",String(t.persona)),t.personaId&&this.setAttribute("persona-id",String(t.personaId)),t.title&&!this.querySelector('[slot="title"]')){let e=document.createElement("h2");e.slot="title",e.textContent=t.title,this.appendChild(e)}if(t.summary&&!this.querySelector('[slot="summary"]')){let e=document.createElement("p");e.slot="summary",e.textContent=t.summary,this.appendChild(e)}t.quadrants!=null&&(this.__quadrants=t.quadrants),t.goals!=null&&(this.__goals=t.goals),t.painPoints!=null&&(this.__painPoints=t.painPoints),this.isConnected&&this._render(),this.dispatchEvent(new CustomEvent("empathy-map:data-changed",{detail:{data:this.data,source:"property"},bubbles:!0,composed:!0}))}}editQuadrant(t){nt.includes(t)&&this.hasAttribute("editable")&&this._openEdit(t)}closeQuadrant(t){nt.includes(t)&&this._closeEdit(t)}async _loadSrc(t){if(t){this.shadowRoot.innerHTML=`<style>${U}</style><div class="state-msg">Loading\u2026</div>`;try{let e=await fetch(t);if(!e.ok)throw new Error(`HTTP ${e.status}`);let s=await e.json();if(s.persona&&this.setAttribute("persona",s.persona),s.personaId&&this.setAttribute("persona-id",s.personaId),s.title&&!this.querySelector('[slot="title"]')){let r=document.createElement("h2");r.slot="title",r.textContent=s.title,this.appendChild(r)}if(s.summary&&!this.querySelector('[slot="summary"]')){let r=document.createElement("p");r.slot="summary",r.textContent=s.summary,this.appendChild(r)}this.__quadrants=s.quadrants||null,this.__goals=s.goals||null,this.__painPoints=s.painPoints||null,this._render()}catch(e){this.shadowRoot.innerHTML=`<style>${U}</style><div class="state-msg state-msg--error">Could not load empathy map: ${f(e.message)}</div>`}}}_render(){let t=this._resolve("persona")||"",e=this._resolve("persona-id")||"",s=this.hasAttribute("compact"),r=this.hasAttribute("editable"),i=!!this.querySelector('[slot="title"]')||this.#e.has("title"),a=!!this.querySelector('[slot="summary"]')||this.#e.has("summary"),o=this.__goals?.length||this.querySelector('[slot="goals"]'),n=this.__painPoints?.length||this.querySelector('[slot="pain-points"]');this.shadowRoot.innerHTML=`<style>${U}</style>
      <article class="empathy-map${s?" empathy-map--compact":""}">
        ...
        <div class="empathy-map__grid">
          ${nt.map(d=>this._renderQuadrant(d,r)).join("")}
        </div>
      ...
      </article>`,r&&this._bindEditListeners(),this.dispatchEvent(new CustomEvent("empathy-map:ready",{bubbles:!0,composed:!0,detail:{title:this.querySelector('[slot="title"]')?.textContent?.trim()||"Empathy Map",persona:t}}))}_renderQuadrant(t,e){let s=et[t],r=this.__quadrants?.[t],i=this._editingQuadrants.has(t),a=r&&r.length?t==="feels"?r.map(n=>this._renderEmotion(n)).join(""):r.map(n=>`<p>${f(n)}</p>`).join(""):`<slot name="${t}"><p class="placeholder">Add ${s.label.toLowerCase()} items\u2026</p></slot>`,o=r?.length?r.join(`
`):"";return`
...
`).map(n=>n.trim()).filter(Boolean);this.__quadrants||(this.__quadrants={}),this.__quadrants[t]=a;let o=e.querySelector(".quadrant__content");if(o)if(a.length)o.innerHTML=t==="feels"?a.map(n=>this._renderEmotion(n)).join(""):a.map(n=>`<p>${f(n)}</p>`).join("");else{let n=et[t];o.innerHTML=`<p class="placeholder">Add ${n.label.toLowerCase()} items\u2026</p>`}}this._editingQuadrants.delete(t),e.removeAttribute("data-editing");let r=e.querySelector(".quadrant__face--front"),i=e.querySelector(".quadrant__face--back");r&&r.removeAttribute("inert"),i&&i.setAttribute("inert",""),this.dispatchEvent(new CustomEvent("empathy-map:update",{bubbles:!0,composed:!0,detail:{quadrant:t,items:this.__quadrants?.[t]||[]}}))}};x("empathy-map",lt);function V({newItems:c,nodes:t,keyOf:e,renderItem:s,containerFor:r}){let i=[],a=[],o=[],n=new Set;for(let l of c)n.add(e(l));for(let[l,h]of[...t])n.has(l)||(h.remove(),t.delete(l),o.push(l));let d=new Map;for(let l of c){let h=e(l),u=t.get(h)||null,m=r(l,u);d.has(m)||d.set(m,[]),d.get(m).push({item:l,key:h,existing:u})}for(let[l,h]of d)for(let u=0;u<h.length;u++){let{item:m,key:b,existing:p}=h[u],g=p;g?(g.parentElement!==l||l.children[u]!==g)&&a.push(b):(g=s(m),t.set(b,g),i.push(b));let v=l.children[u];v!==g&&l.insertBefore(g,v||null)}return{added:i,moved:a,removed:o}}var ct=class c extends C{static QUADRANTS=["quick-wins","big-bets","fill-ins","money-pit"];static LABELS={"quick-wins":"Quick Wins","big-bets":"Big Bets","fill-ins":"Fill-Ins","money-pit":"Money Pit"};static DESCRIPTIONS={"quick-wins":"High impact \xB7 Low effort","big-bets":"High impact \xB7 High effort","fill-ins":"Low impact \xB7 Low effort","money-pit":"Low impact \xB7 High effort"};static#e=0;static get observedAttributes(){return["src","compact","title"]}#t=null;#s={};#i=null;#r="";#o=null;setup(){this.#r=`ie-${++c.#e}`;let t=[...this.querySelectorAll(":scope > [data-quadrant], :scope > [draggable]")],e=document.createElement("div");e.className="ie-wrapper";let s=document.createElement("div");s.className="ie-y-label",s.setAttribute("aria-hidden","true"),s.textContent="Impact \u2191";let r=document.createElement("div");r.style.cssText="display:flex;flex-direction:column;flex:1;min-width:0;";let i=document.createElement("div");i.className="ie-grid",i.setAttribute("role","region"),i.setAttribute("aria-label","Impact-Effort prioritization matrix");let a=document.createElement("div");a.className="ie-x-label",a.setAttribute("aria-hidden","true"),a.textContent="Effort \u2192";for(let l of c.QUADRANTS){let h=document.createElement("section");h.className="ie-quadrant",h.dataset.quadrantZone=l,h.setAttribute("aria-label",`${c.LABELS[l]}: ${c.DESCRIPTIONS[l]}`);let u=document.createElement("header");u.className="ie-quadrant-label",u.innerHTML=`${c.LABELS[l]}<br><span class="ie-quadrant-desc">${c.DESCRIPTIONS[l]}</span>`;let m=document.createElement("drag-surface");m.setAttribute("group",this.#r),m.setAttribute("aria-label",c.LABELS[l]),m.setAttribute("data-layout","stack"),m.setAttribute("data-layout-gap","xs"),h.appendChild(u),h.appendChild(m),i.appendChild(h),this.#s[l]=m}t.forEach((l,h)=>{let u=l.getAttribute("data-quadrant")||"quick-wins",m=this.#s[u]||this.#s["quick-wins"];l.hasAttribute("draggable")||l.setAttribute("draggable","true"),l.hasAttribute("data-id")||(l.dataset.id=`ie-item-${h}`),m.appendChild(l)});let o=document.createElement("div");o.className="ie-live-region",o.setAttribute("role","status"),o.setAttribute("aria-live","polite"),o.setAttribute("aria-atomic","true");let n=this.getAttribute("title");if(n){let l=document.createElement("h3");l.className="ie-title",l.textContent=n,this.prepend(l)}r.appendChild(i),r.appendChild(a),e.appendChild(s),e.appendChild(r),this.appendChild(e),this.appendChild(o),this.#t=i,this.#i=o,this.#o=e,this.listen(this,"drag-surface:transfer",l=>{let{item:h,fromSurface:u,toSurface:m}=l.detail,b=this.#c(u),p=this.#c(m);!b||!p||(h.setAttribute("data-quadrant",p),this.#p(`Moved ${this.#d(h)} to ${c.LABELS[p]}`),this.dispatchEvent(new CustomEvent("impact-effort:move",{bubbles:!0,detail:{itemId:h.dataset.id,from:b,to:p,item:h}})))});let d=this.getAttribute("src");d&&this.#l(d),this.#h()}teardown(){this.#o&&(this.#o.remove(),this.#o=null),this.#i&&(this.#i.remove(),this.#i=null),this.#t=null,this.#s={},this.#n.clear(),this.#a=[]}#a=[];#n=new Map;get items(){if(this.#a.length)return this.#a;let t=[];for(let[e,s]of Object.entries(this.#s))for(let r of s.querySelectorAll(':scope > [draggable="true"]'))t.push({id:r.getAttribute("data-id")||void 0,quadrant:e,text:r.textContent?.trim()||void 0});return t}set items(t){if(!this.#t)return;let e=Array.isArray(t)?t:[];V({newItems:e,nodes:this.#n,keyOf:s=>s.id??`${s.quadrant}:${s.text}`,renderItem:s=>{if(typeof this.renderItem=="function"){let i=this.renderItem(s);if(i instanceof Element)return i.hasAttribute("draggable")||i.setAttribute("draggable","true"),i.hasAttribute("data-id")||i.setAttribute("data-id",String(s.id??"")),i}let r=document.createElement("article");return r.className="ie-card",r.setAttribute("draggable","true"),s.id&&r.setAttribute("data-id",String(s.id)),r.textContent=s.text||s.id||"",r},containerFor:s=>this.#s[s.quadrant]||this.#s["quick-wins"]}),this.#a=e,this.dispatchEvent(new CustomEvent("impact-effort:items-changed",{detail:{items:e,source:"property"},bubbles:!0}))}attributeChangedCallback(t,e,s){this.hasAttribute("data-upgraded")&&t==="src"&&s&&s!==e&&this.#l(s)}async#l(t){try{let e=await fetch(t);if(!e.ok)throw new Error(`HTTP ${e.status}`);let s=await e.json();if(!Array.isArray(s))return;for(let r of c.QUADRANTS){let i=this.#s[r];if(i)for(let a of[...i.querySelectorAll("[draggable]")])a.remove()}s.forEach((r,i)=>{let a=r.quadrant||"quick-wins",o=r.id||`ie-item-${i}`,n;r.persona||r.action||r.storyId?(n=document.createElement("user-story"),n.setAttribute("detail","minimal"),r.storyId&&n.setAttribute("story-id",r.storyId),r.persona&&n.setAttribute("persona",r.persona),r.action&&n.setAttribute("action",r.action),r.benefit&&n.setAttribute("benefit",r.benefit),r.priority&&n.setAttribute("priority",r.priority),r.status&&n.setAttribute("status",r.status),r.points&&n.setAttribute("points",String(r.points))):(n=document.createElement("article"),n.textContent=r.label||r.text||""),n.setAttribute("draggable","true"),n.dataset.id=o,n.dataset.quadrant=a,(this.#s[a]||this.#s["quick-wins"]).appendChild(n)}),this.#h()}catch(e){console.warn(`[impact-effort] Failed to load src="${t}":`,e)}}#c(t){for(let[e,s]of Object.entries(this.#s))if(s===t)return e;return null}#p(t){let e=this.#i;e&&(e.textContent="",requestAnimationFrame(()=>{e.textContent=t}))}#d(t){return t.dataset.id||t.textContent.trim().slice(0,40)}#h(){let t={};for(let e of c.QUADRANTS){let s=this.#s[e];t[e]=s?s.querySelectorAll('[draggable="true"]').length:0}this.dispatchEvent(new CustomEvent("impact-effort:ready",{bubbles:!0,detail:{quadrantCounts:t}}))}};x("impact-effort",ct);var dt=class c extends C{static#e=0;setup(){this.#a=`qg-${++c.#e}`;let t=this.getAttribute("x-label")||"",e=this.getAttribute("y-label")||"",s=this.getAttribute("x-low")||"Low",r=this.getAttribute("x-high")||"High",i=this.getAttribute("y-low")||"Low",a=this.getAttribute("y-high")||"High",o=[this.getAttribute("q1-label")||"Q1",this.getAttribute("q2-label")||"Q2",this.getAttribute("q3-label")||"Q3",this.getAttribute("q4-label")||"Q4"],n=this.hasAttribute("draggable"),d=[...this.querySelectorAll(":scope > [data-quadrant], :scope > [data-x][data-y]")],l=document.createElement("section");l.className="qg-wrapper",l.setAttribute("role","region"),l.setAttribute("aria-label",`${e} \xD7 ${t} quadrant grid`);let h=document.createElement("header");h.className="qg-y-label",h.setAttribute("aria-hidden","true"),h.textContent=`\u2191 ${e}`;let u=document.createElement("aside");u.className="qg-y-scale",u.setAttribute("aria-hidden","true"),u.innerHTML=`<span>${a}</span><span>${i}</span>`;let m=document.createElement("div");m.className="qg-grid";let b=document.createElement("aside");b.className="qg-x-scale",b.setAttribute("aria-hidden","true"),b.innerHTML=`<span>${s}</span><span>${r}</span>`;let p=document.createElement("footer");p.className="qg-x-label",p.setAttribute("aria-hidden","true"),p.textContent=`${t} \u2192`;for(let v=0;v<4;v++){let w=document.createElement("section");w.className="qg-quadrant",w.dataset.quadrantZone=String(v),w.setAttribute("aria-label",o[v]);let y=document.createElement("header");if(y.className="qg-quadrant-label",y.textContent=o[v],w.appendChild(y),n){let _=document.createElement("drag-surface");_.setAttribute("group",this.#a),_.setAttribute("aria-label",o[v]),_.setAttribute("data-layout","stack"),_.setAttribute("data-layout-gap","xs"),w.appendChild(_),this.#n[v]=_}else{let _=document.createElement("ul");_.className="qg-items",w.appendChild(_),this.#l[v]=_}m.appendChild(w),this.#c[v]=w}d.forEach((v,w)=>{let y=this.#s(v),_=n?this.#n[y]:this.#l[y];if(n&&(v.hasAttribute("draggable")||v.setAttribute("draggable","true")),v.hasAttribute("data-id")||(v.dataset.id=`qg-item-${w}`),v.hasAttribute("data-x")&&v.hasAttribute("data-y")){let S=parseFloat(v.getAttribute("data-x")),E=parseFloat(v.getAttribute("data-y"));if(Number.isFinite(S)&&Number.isFinite(E)){let M=y===0||y===3?(S-.5)*2:S*2,I=y===0||y===1?(E-.5)*2:E*2;v.style.setProperty("--qg-local-x",M.toFixed(4)),v.style.setProperty("--qg-local-y",I.toFixed(4)),v.classList.add("qg-pinned")}}if(n)_.appendChild(v);else{let S=document.createElement("li");S.appendChild(v),_.appendChild(S)}});let g=document.createElement("div");g.className="qg-live-region visually-hidden",g.setAttribute("role","status"),g.setAttribute("aria-live","polite"),l.appendChild(h),l.appendChild(u),l.appendChild(m),l.appendChild(b),l.appendChild(p),this.appendChild(l),this.appendChild(g),this.#p=m,this.#d=g,this.#h=o,n&&this.listen(this,"drag-surface:transfer",this.#t)}#t=t=>{let{item:e,fromSurface:s,toSurface:r}=t.detail,i=this.#i(s),a=this.#i(r);i==null||a==null||(e.setAttribute("data-quadrant",String(a)),this.#o(`Moved ${this.#r(e)} to ${this.#h[a]}`),this.dispatchEvent(new CustomEvent("quadrant-grid:move",{bubbles:!0,detail:{item:e,itemId:e.dataset.id,from:i,to:a}})))};#s(t){let e=parseInt(t.getAttribute("data-quadrant"),10);if(e>=0&&e<=3)return e;if(t.hasAttribute("data-x")&&t.hasAttribute("data-y")){let s=parseFloat(t.getAttribute("data-x")),r=parseFloat(t.getAttribute("data-y"));return c.quadrantFor(s,r)}return 0}static quadrantFor(t,e){let s=t>=.5,r=e>=.5;return r&&s?0:r&&!s?1:!r&&!s?2:3}#i(t){for(let e=0;e<4;e++)if(this.#n[e]===t)return e;return null}#r(t){return(t.textContent||"").trim().split(`
`)[0]||"item"}#o(t){this.#d&&(this.#d.textContent=t)}#a="";#n={};#l={};#c={};#p=null;#d=null;#h=[]};x("quadrant-grid",dt);var Mt=5,ht=class c extends C{setup(){let t=this.querySelector(":scope > template"),e=t?c.#t(t):[];if(this.hasAttribute("src")){this.#e(this.getAttribute("src"));return}this.#s(e)}async#e(t){try{let s=await(await fetch(t)).json();this.#s(Array.isArray(s)?s:[])}catch(e){console.warn("risk-register: failed to load src",t,e),this.#s([])}}static#t(t){let e=[],s=t.content.querySelectorAll("tr");for(let r of s){let i=[...r.children],a=i[0]?.textContent?.trim()||"",o=r.getAttribute("data-id")||a.toLowerCase().replace(/\s+/g,"-")||`risk-${e.length}`;e.push({id:o,title:a,likelihood:parseInt(i[1]?.textContent??"",10)||0,impact:parseInt(i[2]?.textContent??"",10)||0,owner:i[3]?.textContent?.trim()||"",mitigation:i[4]?.textContent?.trim()||""})}return e}#s(t){this.#a=t,[...this.children].forEach(r=>{r.tagName!=="TEMPLATE"&&r.remove()});let e=this.getAttribute("label");if(e){let r=document.createElement("header");r.className="rr-label",r.textContent=e,this.appendChild(r)}let s=document.createElement("div");s.className="rr-layout",s.appendChild(this.#i(t)),s.appendChild(this.#r(t)),this.appendChild(s),queueMicrotask(()=>{this.dispatchEvent(new CustomEvent("risk-register:ready",{bubbles:!0,detail:{count:t.length}}))})}#i(t){let e=document.createElement("data-table"),s=document.createElement("table");return s.innerHTML=`
      <thead>
        <tr>
    ...
    `,e.appendChild(s),e}#r(t){let e=document.createElement("quadrant-grid");e.setAttribute("x-label","Likelihood"),e.setAttribute("y-label","Impact"),e.setAttribute("x-low","Rare"),e.setAttribute("x-high","Likely"),e.setAttribute("y-low","Minor"),e.setAttribute("y-high","Severe"),e.setAttribute("q1-label","Avoid"),e.setAttribute("q2-label","Plan"),e.setAttribute("q3-label","Accept"),e.setAttribute("q4-label","Mitigate");for(let s of t){if(!s.likelihood||!s.impact)continue;let r=document.createElement("span"),i=Math.min(1,Math.max(0,s.likelihood/Mt)),a=Math.min(1,Math.max(0,s.impact/Mt));r.setAttribute("data-x",i.toFixed(3)),r.setAttribute("data-y",a.toFixed(3)),r.setAttribute("data-id",s.id),r.setAttribute("title",`${s.title} \u2014 likelihood ${s.likelihood}, impact ${s.impact}`),r.textContent=s.title,e.appendChild(r)}return e}static#o(t){return String(t??"").replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e])}#a=[];get rows(){return[...this.#a]}set rows(t){this.#s(Array.isArray(t)?t:[])}};x("risk-register",ht);var ut=class c extends C{setup(){let t=this.getAttribute("rows"),e=this.getAttribute("cols"),s=this.getAttribute("link-attr");if(!t||!e||!s)return console.warn("traceability-matrix: requires rows, cols, and link-attr attributes"),!1;queueMicrotask(()=>this.#e(t,e,s))}#e(t,e,s){let r=[...document.querySelectorAll(t)].filter(y=>y!==this&&!this.contains(y)),i=[...document.querySelectorAll(e)].filter(y=>y!==this&&!this.contains(y));if(!r.length||!i.length){this.#i();return}let a=this.getAttribute("row-label")||"",o=this.getAttribute("cell-mark")||"\u2713",n=this.hasAttribute("flag-orphans"),d=[],l=new WeakMap,h=new WeakMap;for(let y of r){let _=c.#r(y.getAttribute(s));for(let S of _){let E=i.find(M=>M.id===S);E&&(d.push({rowEl:y,colEl:E}),l.set(y,(l.get(y)||0)+1),h.set(E,(h.get(E)||0)+1))}}let u=document.createElement("data-table"),m=document.createElement("table"),b=document.createElement("thead"),p=document.createElement("tr"),g=document.createElement("th");g.setAttribute("data-sort","string"),g.textContent=a,p.appendChild(g);for(let y of i){let _=document.createElement("th");_.setAttribute("data-sort","number"),_.textContent=c.#o(y),_.dataset.colId=y.id||"",n&&!h.get(y)&&(_.dataset.orphan=""),p.appendChild(_)}b.appendChild(p),m.appendChild(b);let v=document.createElement("tbody");for(let y of r){let _=document.createElement("tr");_.dataset.rowId=y.id||"",n&&!l.get(y)&&(_.dataset.orphan="");let S=document.createElement("th");S.scope="row",S.textContent=c.#o(y),_.appendChild(S);let E=c.#r(y.getAttribute(s));for(let M of i){let I=document.createElement("td"),qt=E.includes(M.id);I.setAttribute("data-sort-value",qt?"1":"0"),qt?(I.dataset.linked="",I.textContent=o,I.setAttribute("aria-label","linked")):I.setAttribute("aria-label","not linked"),I.dataset.colId=M.id||"",_.appendChild(I)}v.appendChild(_)}m.appendChild(v),u.appendChild(m),[...this.children].forEach(y=>{y.tagName!=="TEMPLATE"&&y.remove()});let w=this.getAttribute("label");if(w){let y=document.createElement("header");y.className="tm-label",y.textContent=w,this.appendChild(y)}this.appendChild(u),this.#a=u,this.#n=new Map(r.map(y=>[y.id,y])),this.#l=new Map(i.map(y=>[y.id,y])),this.listen(u,"click",this.#t),queueMicrotask(()=>{this.dispatchEvent(new CustomEvent("traceability-matrix:ready",{bubbles:!0,detail:{rowCount:r.length,colCount:i.length,linkCount:d.length}}))})}#t=t=>{let e=t.target.closest('td, th[scope="row"]');if(!e)return;let s=e.closest("tr");if(!s)return;let r=s.dataset.rowId,i=e.dataset.colId,a=r?this.#n.get(r):null,o=i?this.#l.get(i):null,n=e.hasAttribute("data-state-highlighted");if(this.#s(),n){this.dispatchEvent(new CustomEvent("traceability-matrix:highlight",{bubbles:!0,detail:{rowEl:a,colEl:o,on:!1}}));return}e.setAttribute("data-state-highlighted",""),a&&a.setAttribute("data-state-highlighted",""),o&&o!==a&&o.setAttribute("data-state-highlighted",""),s.setAttribute("data-state-highlighted",""),this.dispatchEvent(new CustomEvent("traceability-matrix:highlight",{bubbles:!0,detail:{rowEl:a,colEl:o,on:!0}}))};#s(){this.#a&&(this.#a.querySelectorAll("[data-state-highlighted]").forEach(t=>t.removeAttribute("data-state-highlighted")),document.querySelectorAll("[data-state-highlighted]").forEach(t=>{(this.#n.has(t.id)||this.#l.has(t.id))&&t.removeAttribute("data-state-highlighted")}))}#i(){[...this.children].forEach(e=>{e.tagName!=="TEMPLATE"&&e.remove()});let t=document.createElement("p");t.className="tm-empty",t.textContent="No matching elements found for this matrix.",this.appendChild(t)}static#r(t){return t?t.split(",").map(e=>e.trim()).filter(Boolean):[]}static#o(t){return t.getAttribute("data-matrix-label")||t.id||(t.textContent||"").trim().split(`
`)[0].slice(0,60)||"(unnamed)"}#a=null;#n=new Map;#l=new Map};x("traceability-matrix",ut);var ee=864e5,pt=class c extends C{setup(){let t=this.getAttribute("start"),e=this.getAttribute("end"),s=parseFloat(this.getAttribute("total"));if(!t||!e||!Number.isFinite(s))return console.warn("burndown-chart: requires start, end, and total attributes"),!1;let r=c.#s(t),i=c.#s(e);if(!r||!i||i<r)return console.warn("burndown-chart: start/end dates invalid",t,e),!1;let a=(this.getAttribute("weekends")||"include")!=="exclude",o=this.getAttribute("unit")||"points",n=this.getAttribute("label")||"",d=this.querySelector(":scope > template"),l=d?c.#t(d):[],h=l.filter(p=>p.delta!==0),u=c.#r(r,i),m=c.#o(u,s,a),b=c.#a(u,l);this.#e({label:n,unit:o,dayLabels:u,actual:b,ideal:m,scopeChanges:h}),queueMicrotask(()=>{this.dispatchEvent(new CustomEvent("burndown-chart:ready",{bubbles:!0,detail:{dayCount:u.length,total:s,scopeChanges:h.length}}))})}#e({label:t,unit:e,dayLabels:s,actual:r,ideal:i,scopeChanges:a}){if([...this.children].forEach(h=>{h.tagName!=="TEMPLATE"&&h.remove()}),t){let h=document.createElement("header");h.className="bdc-label",h.textContent=t,this.appendChild(h)}let o=document.createElement("chart-wc");o.setAttribute("data-type","line"),o.setAttribute("data-legend",""),o.setAttribute("data-tooltip",""),o.setAttribute("data-label-x","Day"),o.setAttribute("data-label-y",e);let n={},d={};s.forEach((h,u)=>{n[h]=i[u],r[u]!==null&&(d[h]=r[u])});let l=[{name:"Actual",values:d},{name:"Ideal",values:n}];if(o.setAttribute("data-values",JSON.stringify(l)),this.appendChild(o),a.length){let h=document.createElement("aside");h.className="bdc-scope-changes";let u=document.createElement("h4");u.textContent="Scope changes",h.appendChild(u);let m=document.createElement("ul");for(let b of a){let p=document.createElement("li"),g=b.delta>0?"+":"";p.innerHTML=`<time datetime="${b.date}">${b.date}</time>: <strong>${g}${b.delta} ${e}</strong>`,m.appendChild(p)}h.appendChild(m),this.appendChild(h)}}static#t(t){let e=[],s=t.content.querySelectorAll("tr");for(let r of s){let i=[...r.children],a=i[0]?.textContent?.trim(),o=parseFloat(i[1]?.textContent??""),n=parseFloat(i[2]?.textContent??"0")||0;!a||!Number.isFinite(o)||e.push({date:a,remaining:o,delta:n})}return e}static#s(t){let e=String(t).match(/^(\d{4})-(\d{2})-(\d{2})/);return e?new Date(Number(e[1]),Number(e[2])-1,Number(e[3])):null}static#i(t){let e=String(t.getMonth()+1).padStart(2,"0"),s=String(t.getDate()).padStart(2,"0");return`${t.getFullYear()}-${e}-${s}`}static#r(t,e){let s=[];for(let r=t.getTime();r<=e.getTime();r+=ee)s.push(c.#i(new Date(r)));return s}static#o(t,e,s){let r=l=>{let u=c.#s(l).getDay();return u===0||u===6},i=t.map((l,h)=>({d:l,i:h,weekend:r(l)})).filter(l=>s||!l.weekend),a=i.length>1?e/(i.length-1):0,o=new Array(t.length).fill(null),n=e,d=0;for(let l=0;l<t.length;l++){let h=r(t[l]);s||!h?(o[l]=Math.max(0,e-a*d),d++,n=o[l]):o[l]=n}return o}static#a(t,e){let s=new Map(e.map(r=>[r.date,r.remaining]));return t.map(r=>s.has(r)?s.get(r):null)}};x("burndown-chart",pt);var mt=class c extends C{setup(){let t=this.getAttribute("start"),e=this.getAttribute("end");if(!t||!e)return console.warn("product-roadmap: start and end attributes required"),!1;let s=c.#f(t,"start"),r=c.#f(e,"end");if(!s||!r||r<=s)return console.warn("product-roadmap: invalid start/end",t,e),!1;this.#u=s,this.#b=r,this.#w=r.getTime()-s.getTime(),this.#g=this.getAttribute("view")==="month"?"month":"quarter",this.#v=this.hasAttribute("editable");let i=[...this.querySelectorAll(":scope > section[data-lane]")];if(!i.length)return console.warn("product-roadmap: no <section data-lane> children found"),!1;this.#m=i,this.#e()}attributeChangedCallback(){this.isConnected&&this.#m.length&&this.#e()}#e(){[...this.children].forEach(r=>{this.#m.includes(r)||r.remove()}),this.#m.forEach(r=>{r.hidden=!0});let t=document.createElement("div");t.className="rm-wrapper";let e=this.#t();t.appendChild(e);let s=document.createElement("div");s.className="rm-lanes";for(let r of this.#m){let i=r.getAttribute("data-lane")||"",a=document.createElement("section");a.className="rm-lane",a.dataset.lane=i;let o=document.createElement("header");o.className="rm-lane-label",o.textContent=i,a.appendChild(o);let n=document.createElement("div");n.className="rm-track",n.dataset.lane=i;let d=[...r.querySelectorAll(":scope > article[data-start][data-end]")];for(let l of d){let h=this.#s(l,i);h&&n.appendChild(h)}this.#v&&(n.addEventListener("dragover",this.#n),n.addEventListener("drop",this.#l)),a.appendChild(n),s.appendChild(a)}if(t.appendChild(s),this.hasAttribute("today-marker")){let r=new Date;if(r>=this.#u&&r<=this.#b){let i=document.createElement("div");i.className="rm-today",i.style.setProperty("--rm-x",this.#c(r).toFixed(4)),i.title=`Today: ${c.#x(r)}`,s.appendChild(i)}}this.appendChild(t),this.#k=t}#t(){let t=document.createElement("header");t.className="rm-axis";let e=this.#h();for(let s of e){let r=document.createElement("div");r.className="rm-tick",r.style.setProperty("--rm-x",s.startFraction.toFixed(4)),r.style.setProperty("--rm-w",(s.endFraction-s.startFraction).toFixed(4)),r.textContent=s.label,t.appendChild(r)}return t}#s(t,e){let s=c.#f(t.getAttribute("data-start"),"start"),r=c.#f(t.getAttribute("data-end"),"end");if(!s||!r)return null;let i=s<this.#u?this.#u:s,a=r>this.#b?this.#b:r;if(i>=a)return null;let o=this.#c(i),n=this.#c(a)-o,d=document.createElement("article");d.className="rm-bar",d.style.setProperty("--rm-x",o.toFixed(4)),d.style.setProperty("--rm-w",n.toFixed(4)),d.dataset.lane=e,d.dataset.start=c.#x(s),d.dataset.end=c.#x(r),t.dataset.status&&(d.dataset.status=t.dataset.status),t.id&&(d.dataset.sourceId=t.id),this.#v&&d.setAttribute("draggable","true");let l=t.querySelector("h1, h2, h3, h4, h5, h6"),h=document.createElement("span");if(h.className="rm-bar-title",h.textContent=l?l.textContent.trim():(t.textContent||"").trim().split(`
`)[0],d.appendChild(h),d.setAttribute("aria-label",`${h.textContent} \u2014 ${d.dataset.start} to ${d.dataset.end} in ${e}`),d.addEventListener("click",u=>{this.#A||this.dispatchEvent(new CustomEvent("product-roadmap:select",{bubbles:!0,detail:{initiative:t,lane:e,start:d.dataset.start,end:d.dataset.end,status:d.dataset.status||null}}))}),this.#v){let u=document.createElement("span");u.className="rm-bar-handle",u.setAttribute("aria-label","Resize end date"),d.appendChild(u),u.addEventListener("pointerdown",m=>this.#r(m,d,t)),d.addEventListener("pointerdown",m=>{m.target!==u&&this.#i(m,d,t)}),d.addEventListener("dragstart",m=>{m.dataTransfer.effectAllowed="move",m.dataTransfer.setData("text/plain",t.id||d.dataset.sourceId||""),this.#_=t,this.#C=e}),d.addEventListener("dragend",()=>{this.#_=null,this.#C=null})}return d}#i(t,e,s){if(t.button!==0)return;t.preventDefault();let r=e.parentElement.getBoundingClientRect(),i=t.clientX,a=parseFloat(e.style.getPropertyValue("--rm-x"))||0,o=parseFloat(e.style.getPropertyValue("--rm-w"))||0;this.#A={kind:"move",bar:e,initiative:s,trackRect:r,startX:i,startFraction:a,widthFraction:o},e.setPointerCapture(t.pointerId),e.addEventListener("pointermove",this.#o),e.addEventListener("pointerup",this.#a),e.addEventListener("pointercancel",this.#a)}#r(t,e,s){if(t.button!==0)return;t.preventDefault(),t.stopPropagation();let r=e.parentElement.getBoundingClientRect(),i=t.clientX,a=parseFloat(e.style.getPropertyValue("--rm-x"))||0,o=parseFloat(e.style.getPropertyValue("--rm-w"))||0;this.#A={kind:"resize",bar:e,initiative:s,trackRect:r,startX:i,startFraction:a,widthFraction:o},e.setPointerCapture(t.pointerId),e.addEventListener("pointermove",this.#o),e.addEventListener("pointerup",this.#a),e.addEventListener("pointercancel",this.#a)}#o=t=>{if(!this.#A)return;let{kind:e,bar:s,trackRect:r,startX:i,startFraction:a,widthFraction:o}=this.#A,n=(t.clientX-i)/r.width;if(e==="move"){let d=Math.max(0,Math.min(1-o,a+n));s.style.setProperty("--rm-x",d.toFixed(4))}else if(e==="resize"){let d=Math.max(.02,Math.min(1-a,o+n));s.style.setProperty("--rm-w",d.toFixed(4))}};#a=t=>{if(!this.#A)return;let{kind:e,bar:s,initiative:r}=this.#A;s.releasePointerCapture(t.pointerId),s.removeEventListener("pointermove",this.#o),s.removeEventListener("pointerup",this.#a),s.removeEventListener("pointercancel",this.#a);let i=parseFloat(s.style.getPropertyValue("--rm-x"))||0,a=parseFloat(s.style.getPropertyValue("--rm-w"))||0,o=this.#d(this.#p(i)),n=this.#d(this.#p(i+a));s.dataset.start=c.#x(o),s.dataset.end=c.#x(n);let d=this.#c(o),l=this.#c(n)-d;s.style.setProperty("--rm-x",d.toFixed(4)),s.style.setProperty("--rm-w",l.toFixed(4)),r.setAttribute("data-start",s.dataset.start),r.setAttribute("data-end",s.dataset.end),this.dispatchEvent(new CustomEvent(e==="move"?"product-roadmap:reschedule":"product-roadmap:resize",{bubbles:!0,detail:{initiative:r,lane:s.dataset.lane,start:s.dataset.start,end:s.dataset.end}})),setTimeout(()=>{this.#A=null},0)};#n=t=>{this.#_&&(t.preventDefault(),t.dataTransfer.dropEffect="move")};#l=t=>{if(!this.#_)return;t.preventDefault();let e=t.currentTarget.dataset.lane,s=this.#_,r=this.#C;if(e===r)return;let i=this.#m.find(a=>a.getAttribute("data-lane")===e);i&&i.appendChild(s),this.dispatchEvent(new CustomEvent("product-roadmap:move",{bubbles:!0,detail:{initiative:s,fromLane:r,toLane:e,start:s.getAttribute("data-start"),end:s.getAttribute("data-end")}})),this.#e()};#c(t){let e=t.getTime()-this.#u.getTime();return Math.max(0,Math.min(1,e/this.#w))}#p(t){return new Date(this.#u.getTime()+t*this.#w)}#d(t){if(this.#g==="month")return new Date(t.getFullYear(),t.getMonth(),1);let e=t.getMonth(),s=Math.floor(e/3)*3;return new Date(t.getFullYear(),s,1)}#h(){let t=[];if(this.#g==="quarter"){let e=this.#d(this.#u);for(;e<this.#b;){let s=new Date(e.getFullYear(),e.getMonth()+3,1),r=this.#c(e<this.#u?this.#u:e),i=this.#c(s>this.#b?this.#b:s),a=Math.floor(e.getMonth()/3)+1;t.push({startFraction:r,endFraction:i,label:`Q${a} ${e.getFullYear()}`}),e=s}}else{let e=new Date(this.#u.getFullYear(),this.#u.getMonth(),1);for(;e<this.#b;){let s=new Date(e.getFullYear(),e.getMonth()+1,1),r=this.#c(e<this.#u?this.#u:e),i=this.#c(s>this.#b?this.#b:s),a=e.toLocaleString(void 0,{month:"short"});t.push({startFraction:r,endFraction:i,label:`${a} ${e.getFullYear()}`}),e=s}}return t}static#f(t,e){if(!t)return null;let s=String(t).match(/^(\d{4})-Q([1-4])$/i);if(s){let a=Number(s[1]),n=(Number(s[2])-1)*3;return e==="end"?new Date(a,n+3,0):new Date(a,n,1)}let r=String(t).match(/^(\d{4})-(\d{2})-(\d{2})/);if(r)return new Date(Number(r[1]),Number(r[2])-1,Number(r[3]));let i=new Date(t);return isNaN(i.getTime())?null:i}static#x(t){let e=String(t.getMonth()+1).padStart(2,"0"),s=String(t.getDate()).padStart(2,"0");return`${t.getFullYear()}-${e}-${s}`}#u=null;#b=null;#w=0;#g="quarter";#v=!1;#m=[];#k=null;#A=null;#_=null;#C=null};x("product-roadmap",mt);function Lt(c){return class extends c{static keyOf(t){return t.id}#e=[];#t=new Map;get items(){return this.#e}set items(t){let e=t||[],s=V({newItems:e,nodes:this.#t,keyOf:this.constructor.keyOf,renderItem:r=>this._renderItem(r),containerFor:(r,i)=>this._containerFor(r,i)});this.#e=e,this._postRender({...s,items:e}),this._emit("items-changed",{items:e},"api")}_renderItem(t){throw new Error(`${this.constructor.name}: must implement _renderItem(item)`)}_containerFor(t,e){return this}_postRender(t){}_emit(t,e,s="api"){this.dispatchEvent(new CustomEvent(`${this.localName}:${t}`,{detail:{...e,source:s},bubbles:!0}))}_nodeFor(t){return this.#t.get(t)||null}_seedCollection(t,e){this.#e=t,this.#t.clear();for(let[s,r]of e)this.#t.set(s,r)}_setItemsSilently(t){this.#e=t}}}var ft=class c extends Lt(C){static get observedAttributes(){return["src","compact","title"]}static keyOf(t){return t.id??t.storyId}static#e=0;#t=null;#s={};#i={};#r=null;#o="";#a=[];#n=null;setup(){this.#o=`kb-${++c.#e}`;let t=[...this.querySelectorAll(":scope > section[data-column]")];this.#a=t.map(i=>{let a=i.getAttribute("data-column")||"",n=i.getAttribute("data-column-label")||""||this.#w(a),d=i.getAttribute("data-wip"),l=d?parseInt(d,10):null,h=i.getAttribute("data-column-color")||null,u=[...i.children];return{id:a,label:n,wip:l,color:h,children:u}});for(let i of t)i.remove();this.#t=document.createElement("div"),this.#t.className="kb-columns",this.#t.setAttribute("role","region"),this.#t.setAttribute("aria-label","Kanban board");let e=0;for(let i of this.#a){let a=document.createElement("section");a.className="kb-column",a.setAttribute("data-column-id",i.id),i.color&&a.setAttribute("data-column-tint",i.color);let o=document.createElement("header");o.className="kb-column-header";let n=document.createElement("h3");n.textContent=i.label;let d=document.createElement("output");if(d.className="kb-count",d.textContent=String(i.children.length),n.appendChild(d),i.wip!==null&&!isNaN(i.wip)){let h=document.createElement("span");h.className="kb-wip",h.textContent=`/ ${i.wip}`,h.setAttribute("aria-label",`WIP limit ${i.wip}`),n.appendChild(h)}o.appendChild(n),a.appendChild(o);let l=document.createElement("drag-surface");if(l.setAttribute("group",this.#o),l.setAttribute("aria-label",`${i.label} items`),l.setAttribute("data-layout","stack"),l.setAttribute("data-layout-gap","xs"),i.children.length>0){for(let h of i.children)h.hasAttribute("draggable")||h.setAttribute("draggable","true"),h.hasAttribute("data-id")||(h.dataset.id=`kb-item-${e}`),l.appendChild(h);e+=i.children.length}else{let h=document.createElement("p");h.className="kb-empty",h.textContent="No items",l.appendChild(h)}a.appendChild(l),this.#t.appendChild(a),this.#s[i.id]=l,this.#i[i.id]=a,i.wip!==null&&i.children.length>i.wip&&a.setAttribute("data-wip-exceeded","")}let s=this.getAttribute("title");if(s){let i=document.createElement("h2");i.className="kb-title",i.textContent=s,this.appendChild(i)}this.appendChild(this.#t),this.#r=document.createElement("div"),this.#r.className="kb-live-region",this.#r.setAttribute("role","status"),this.#r.setAttribute("aria-live","polite"),this.#r.setAttribute("aria-atomic","true"),this.appendChild(this.#r),this.listen(this,"drag-surface:reorder",i=>{let a=i.detail,o=i.target.closest("drag-surface"),n=this.#h(o);n&&(this.#f(n),this.#c("drag"),this.dispatchEvent(new CustomEvent("kanban-board:reorder",{bubbles:!0,detail:{itemId:a.itemId,column:n,oldIndex:a.oldIndex,newIndex:a.newIndex}})))}),this.listen(this,"drag-surface:transfer",i=>{let a=i.detail,o=a.fromSurface,n=a.toSurface,d=this.#h(o),l=this.#h(n);if(!d||!l)return;a.item&&a.item.setAttribute("data-column",l),this.#f(d),this.#f(l);let h=n.querySelector(".kb-empty");if(h&&h.remove(),o.querySelectorAll(':scope > [draggable="true"]').length===0&&!o.querySelector(".kb-empty")){let w=document.createElement("p");w.className="kb-empty",w.textContent="No items",o.appendChild(w)}let m=this.#b(a.item),b=this.#x(d),p=this.#x(l);this.#u(`${m} moved from ${b} to ${p}`),this.#c("drag"),this.dispatchEvent(new CustomEvent("kanban-board:transfer",{bubbles:!0,detail:{itemId:a.itemId,fromColumn:d,toColumn:l,newIndex:a.newIndex,item:a.item}}));let g=n.querySelectorAll(':scope > [draggable="true"]').length,v=this.#a.find(w=>w.id===l);v?.wip!==null&&v?.wip!==void 0&&g>v.wip&&this.dispatchEvent(new CustomEvent("kanban-board:wip-exceeded",{bubbles:!0,detail:{column:l,limit:v.wip,count:g}}))}),this.#l();let r=this.getAttribute("src");if(r){this._loadSrc(r);return}this.dispatchEvent(new CustomEvent("kanban-board:ready",{bubbles:!0,detail:{columnCount:this.#a.length,itemCount:e}}))}#l(){let t=[],e=new Map;for(let[s,r]of Object.entries(this.#s)){let i=r.querySelectorAll(':scope > [draggable="true"]');for(let a of i){let o=a.getAttribute("data-id");o&&(t.push({id:o,column:s}),e.set(o,a))}}this._seedCollection(t,e)}#c(t){let e=[],s=new Map;for(let r of this.items){let i=String(r.id??r.storyId??"");i&&s.set(i,r)}for(let[r,i]of Object.entries(this.#s)){let a=i.querySelectorAll(':scope > [draggable="true"]');for(let o of a){let n=o.getAttribute("data-id");if(!n)continue;let d=s.get(n);e.push(d?{...d,column:r}:{id:n,column:r})}}this._setItemsSilently(e),this._emit("items-changed",{items:e},t)}teardown(){let t=this.querySelector(".kb-title");t&&t.remove(),this.#t&&(this.#t.remove(),this.#t=null),this.#r&&(this.#r.remove(),this.#r=null),this.#s={},this.#i={},this.#a=[]}get columns(){return this.#a.map(t=>({id:t.id,label:t.label,wip:t.wip??void 0,color:t.color??void 0}))}set columns(t){let e=(t||[]).map(s=>({id:s.id,label:s.label||this.#w(s.id),wip:s.wip??null,color:s.color??null,children:[]}));this.#t&&(this.#t.remove(),this.#t=null),this.#s={},this.#i={},this.#a=e,this.#d()}get renderItem(){return this.#n}set renderItem(t){this.#n=typeof t=="function"?t:null}_renderItem(t){let e;if(this.#n){let s=this.#n(t);if(!(s instanceof Element))throw new Error("kanban-board: renderItem must return an Element");e=s}else e=this.#p(t);return e.hasAttribute("draggable")||e.setAttribute("draggable","true"),e.hasAttribute("data-id")||e.setAttribute("data-id",String(c.keyOf(t))),e}_containerFor(t,e){let s=this.#s[t.column];if(!s)throw new Error(`kanban-board: no column "${t.column}" \u2014 set .columns first or include item.column matching an existing column id`);let r=s.querySelector(":scope > .kb-empty");return r&&r.remove(),s}_postRender(){for(let t of Object.keys(this.#s)){this.#f(t);let e=this.#s[t],s=e.querySelectorAll(':scope > [draggable="true"]'),r=e.querySelector(":scope > .kb-empty");if(s.length===0&&!r){let i=document.createElement("p");i.className="kb-empty",i.textContent="No items",e.appendChild(i)}else s.length>0&&r&&r.remove()}}#p(t){let e=customElements.get("work-item")?"work-item":"article",s=document.createElement(e);return e==="work-item"?s.data={itemId:t.id??t.storyId,type:t.type,priority:t.priority,status:t.status,estimate:t.estimate!=null?String(t.estimate):void 0,assignee:t.assignee,title:t.title,description:t.description,checklist:t.checklist,notes:t.notes,detail:t.detail}:(s.className="kb-card",s.textContent=t.title||t.label||t.id),s}#d(){this.#t=document.createElement("div"),this.#t.className="kb-columns",this.#t.setAttribute("role","region"),this.#t.setAttribute("aria-label","Kanban board");for(let t of this.#a){let e=document.createElement("section");e.className="kb-column",e.setAttribute("data-column-id",t.id),t.color&&e.setAttribute("data-column-tint",t.color);let s=document.createElement("header");s.className="kb-column-header";let r=document.createElement("h3");r.textContent=t.label;let i=document.createElement("output");if(i.className="kb-count",i.textContent="0",r.appendChild(i),t.wip!=null&&!isNaN(t.wip)){let n=document.createElement("span");n.className="kb-wip",n.textContent=`/ ${t.wip}`,n.setAttribute("aria-label",`WIP limit ${t.wip}`),r.appendChild(n)}s.appendChild(r),e.appendChild(s);let a=document.createElement("drag-surface");a.setAttribute("group",this.#o),a.setAttribute("aria-label",`${t.label} items`),a.setAttribute("data-layout","stack"),a.setAttribute("data-layout-gap","xs");let o=document.createElement("p");o.className="kb-empty",o.textContent="No items",a.appendChild(o),e.appendChild(a),this.#t.appendChild(e),this.#s[t.id]=a,this.#i[t.id]=e}this.appendChild(this.#t)}attributeChangedCallback(t,e,s){e===s||!this.isConnected||t==="src"&&this._loadSrc(s)}async _loadSrc(t){if(t)try{let e=await fetch(t);if(!e.ok)throw new Error(`HTTP ${e.status}`);let s=await e.json();for(;this.firstChild;)this.firstChild.remove();for(let r of s.columns||[]){let i=document.createElement("section");i.setAttribute("data-column",r.id),r.label&&i.setAttribute("data-column-label",r.label),r.wip!=null&&i.setAttribute("data-wip",String(r.wip)),r.color&&i.setAttribute("data-column-color",r.color);for(let a of r.items||[]){let o;a.persona||a.action||a.storyId?(o=document.createElement("user-story"),o.setAttribute("detail",a.detail||"minimal"),a.storyId&&o.setAttribute("story-id",a.storyId),a.persona&&o.setAttribute("persona",a.persona),a.action&&o.setAttribute("action",a.action),a.benefit&&o.setAttribute("benefit",a.benefit),a.priority&&o.setAttribute("priority",a.priority),a.status&&o.setAttribute("status",a.status),a.points&&o.setAttribute("points",String(a.points))):(o=document.createElement("article"),o.className="kb-card",o.textContent=a.text||a.label||""),o.setAttribute("draggable","true"),o.dataset.id=a.id||a.storyId||"",i.appendChild(o)}this.appendChild(i)}this.teardown(),this.removeAttribute("data-upgraded"),this.setup()}catch(e){console.warn(`[kanban-board] Failed to load src="${t}":`,e)}}#h(t){if(!t)return null;for(let[e,s]of Object.entries(this.#s))if(s===t)return e;return null}#f(t){let e=this.#s[t],s=this.#i[t];if(!e||!s)return;let r=e.querySelectorAll(':scope > [draggable="true"]').length,i=s.querySelector(".kb-count");i&&(i.textContent=String(r));let a=this.#a.find(o=>o.id===t);a?.wip!==null&&a?.wip!==void 0&&(r>a.wip?s.setAttribute("data-wip-exceeded",""):s.removeAttribute("data-wip-exceeded"))}#x(t){return this.#a.find(s=>s.id===t)?.label||this.#w(t)}#u(t){this.#r&&(this.#r.textContent="",requestAnimationFrame(()=>{this.#r&&(this.#r.textContent=t)}))}#b(t){return t.getAttribute("story-id")||t.getAttribute("data-id")||t.textContent?.trim().slice(0,40)||"item"}#w(t){return t.replace(/[-_]/g," ").replace(/\b\w/g,e=>e.toUpperCase())}};x("kanban-board",ft);var bt=class c extends C{static get observedAttributes(){return["src","compact","title"]}static#e=0;#t=null;#s=null;#i={};#r=null;#o="";#a=[];setup(){this.#o=`sm-${++c.#e}`;let t=[...this.querySelectorAll(":scope > section[data-activity]")];this.#a=t.map(i=>{let a=i.getAttribute("data-activity")||"",n=i.getAttribute("data-activity-label")||""||this.#d(a),d=i.getAttribute("data-journey-phase")||null,l=[...i.children];return{id:a,label:n,journeyPhase:d,children:l}});for(let i of t)i.remove();this.#t=document.createElement("div"),this.#t.className="sm-scroll",this.#t.setAttribute("role","region"),this.#t.setAttribute("aria-label","Story map"),this.#t.setAttribute("tabindex","0"),this.#s=document.createElement("div"),this.#s.className="sm-columns";let e=0;for(let i of this.#a){let a=document.createElement("section");a.className="sm-column",a.setAttribute("data-activity-column",i.id);let o=document.createElement("header");o.className="sm-activity-header";let n=document.createElement("h3");n.textContent=i.label;let d=document.createElement("span");d.className="sm-activity-count",d.textContent=String(i.children.length),n.appendChild(d),o.appendChild(n),a.appendChild(o);let l=document.createElement("drag-surface");if(l.setAttribute("group",this.#o),l.setAttribute("aria-label",`${i.label} stories`),l.setAttribute("data-layout","stack"),l.setAttribute("data-layout-gap","xs"),i.children.length>0){for(let h of i.children)l.appendChild(h);e+=i.children.length}else{let h=document.createElement("p");h.className="sm-empty",h.textContent="No stories yet",l.appendChild(h)}a.appendChild(l),this.#s.appendChild(a),this.#i[i.id]=l}let s=this.getAttribute("title");if(s){let i=document.createElement("h2");i.className="sm-title",i.textContent=s,this.appendChild(i)}this.#t.appendChild(this.#s),this.appendChild(this.#t),this.#r=document.createElement("div"),this.#r.className="sm-live-region",this.#r.setAttribute("role","status"),this.#r.setAttribute("aria-live","polite"),this.#r.setAttribute("aria-atomic","true"),this.appendChild(this.#r),this.listen(this,"drag-surface:reorder",i=>{let a=i.detail,o=i.target.closest("drag-surface"),n=this.#n(o);n&&(this.#l(n),this.dispatchEvent(new CustomEvent("story-map:reorder",{bubbles:!0,detail:{itemId:a.itemId,activity:n,oldIndex:a.oldIndex,newIndex:a.newIndex}})))}),this.listen(this,"drag-surface:transfer",i=>{let a=i.detail,o=a.fromSurface,n=a.toSurface,d=this.#n(o),l=this.#n(n);if(!d||!l)return;this.#l(d),this.#l(l);let h=n.querySelector(".sm-empty");if(h&&h.remove(),o.querySelectorAll(':scope > [draggable="true"]').length===0&&!o.querySelector(".sm-empty")){let b=document.createElement("p");b.className="sm-empty",b.textContent="No stories yet",o.appendChild(b)}let m=this.#p(a.item);this.#c(`${m} moved from ${d} to ${l}`),this.dispatchEvent(new CustomEvent("story-map:transfer",{bubbles:!0,detail:{itemId:a.itemId,fromActivity:d,toActivity:l,newIndex:a.newIndex}}))});let r=this.getAttribute("src");if(r){this._loadSrc(r);return}this.dispatchEvent(new CustomEvent("story-map:ready",{bubbles:!0,detail:{activityCount:this.#a.length,storyCount:e}}))}teardown(){this.#t&&(this.#t.remove(),this.#t=null),this.#r&&(this.#r.remove(),this.#r=null),this.#s=null,this.#i={},this.#a=[]}get activities(){return this.#a.map(t=>({id:t.id,label:t.label,journeyPhase:t.journeyPhase||void 0,stories:[...this.#i[t.id]?.querySelectorAll(':scope > [draggable="true"]')||[]].map(e=>({id:e.getAttribute("data-id")||void 0,storyId:e.getAttribute("story-id")||void 0,title:e.querySelector('[slot="title"]')?.textContent?.trim()||void 0}))}))}set activities(t){let e=Array.isArray(t)?t:[];for(;this.firstChild;)this.firstChild.remove();for(let s of e){let r=document.createElement("section");r.setAttribute("data-activity",s.id||""),s.label&&r.setAttribute("data-activity-label",s.label),s.journeyPhase&&r.setAttribute("data-journey-phase",s.journeyPhase);for(let i of s.stories||[]){let a;if(typeof this.renderStory=="function"){let o=this.renderStory(i);a=o instanceof Element?o:null}a||(customElements.get("user-story")?(a=document.createElement("user-story"),a.data=i):(a=document.createElement("article"),a.className="sm-card",a.textContent=i.title||i.id||"")),a.hasAttribute("draggable")||a.setAttribute("draggable","true"),i.id&&!a.hasAttribute("data-id")&&a.setAttribute("data-id",String(i.id)),r.appendChild(a)}this.appendChild(r)}this.teardown(),this.removeAttribute("data-upgraded"),this.setup(),this.dispatchEvent(new CustomEvent("story-map:activities-changed",{detail:{activities:e,source:"property"},bubbles:!0}))}attributeChangedCallback(t,e,s){e===s||!this.isConnected||t==="src"&&this._loadSrc(s)}async _loadSrc(t){if(t)try{let e=await fetch(t);if(!e.ok)throw new Error(`HTTP ${e.status}`);let s=await e.json();for(;this.firstChild;)this.firstChild.remove();for(let r of s.activities||[]){let i=document.createElement("section");i.setAttribute("data-activity",r.id),i.setAttribute("data-activity-label",r.label||r.id),r.journeyPhase&&i.setAttribute("data-journey-phase",r.journeyPhase);for(let a of r.stories||[]){let o=document.createElement("user-story");o.setAttribute("draggable","true"),o.dataset.id=a.id||a.storyId,(a.storyId||a.id)&&o.setAttribute("story-id",a.storyId||a.id),a.title&&o.setAttribute("title",a.title),a.persona&&o.setAttribute("persona",a.persona),a.action&&o.setAttribute("action",a.action),a.benefit&&o.setAttribute("benefit",a.benefit),a.priority&&o.setAttribute("priority",a.priority),a.status&&o.setAttribute("status",a.status),a.points&&o.setAttribute("points",String(a.points)),o.setAttribute("detail",a.detail||"compact"),i.appendChild(o)}this.appendChild(i)}this.teardown(),this.removeAttribute("data-upgraded"),this.setup()}catch(e){console.warn(`[story-map] Failed to load src="${t}":`,e)}}#n(t){if(!t)return null;for(let[e,s]of Object.entries(this.#i))if(s===t)return e;return null}#l(t){let e=this.#i[t];if(!e)return;let s=e.querySelectorAll(':scope > [draggable="true"]').length,r=e.closest("[data-activity-column]");if(!r)return;let i=r.querySelector(".sm-activity-count");i&&(i.textContent=String(s))}#c(t){this.#r&&(this.#r.textContent="",requestAnimationFrame(()=>{this.#r&&(this.#r.textContent=t)}))}#p(t){return t.getAttribute("story-id")||t.getAttribute("data-id")||t.textContent?.trim().slice(0,40)||"item"}#d(t){return t.replace(/[-_]/g," ").replace(/\b\w/g,e=>e.toUpperCase())}};x("story-map",bt);var Y=`
  :host {
    display: block;
    position: relative;
    font-family: var(--_font-sans);
...
`;function se(){let c=globalThis.localStorage;if(!c)throw new Error("VBStore: localStorage is not available in this environment");return{async getRaw(t){return c.getItem(t)},async setRaw(t,e){c.setItem(t,e)},async removeRaw(t){c.removeItem(t)},async keys(t){let e=[];for(let s=0;s<c.length;s++){let r=c.key(s);r&&r.startsWith(t)&&e.push(r)}return e}}}var W=null;function N(){return W||(W=se()),W}function gt(c,t){if(typeof c!="string"||!c)throw new TypeError("VBStore: namespace must be a non-empty string");if(typeof t!="string"||!t)throw new TypeError("VBStore: key must be a non-empty string");return`vb:${c}:${t}`}function zt(c){if(typeof c!="string"||!c)throw new TypeError("VBStore: namespace must be a non-empty string");return`vb:${c}:`}function Dt(c){try{let t=JSON.parse(c);if(t&&typeof t=="object"&&typeof t.timestamp=="number")return t}catch{}return null}var X={configure(c={}){W=c.backend??null},async set(c,t,e){let s={data:e,timestamp:Date.now()};await N().setRaw(gt(c,t),JSON.stringify(s))},async get(c,t,e){let s=await N().getRaw(gt(c,t));if(s==null)return null;let r=Dt(s);return!r||e?.maxAge!=null&&Date.now()-r.timestamp>e.maxAge?null:r.data},async remove(c,t){await N().removeRaw(gt(c,t))},async list(c){let t=zt(c),e=await N().keys(t),s=[];for(let r of e){let i=await N().getRaw(r);if(i==null)continue;let a=Dt(i);a&&s.push({key:r.slice(t.length),data:a.data,timestamp:a.timestamp})}return s},async clear(c){let t=zt(c),e=await N().keys(t);for(let s of e)await N().removeRaw(s)},async clearAll(){let c=await N().keys("vb:");for(let t of c)await N().removeRaw(t)},async setMany(c,t){for(let[e,s]of t)await X.set(c,e,s)}};var P=class{#e=new Map;async load(){return[...this.#e.values()]}async save(t){return t.id||(t.id=crypto.randomUUID()),this.#e.set(t.id,t),t}async update(t,e){let s=this.#e.get(t);if(!s)throw new Error(`Pin ${t} not found`);return Object.assign(s,e),s}async remove(t){this.#e.delete(t)}},Q=class{#e;constructor(t="default"){this.#e=t}async#t(){let t=await X.get("reviews",this.#e);return Array.isArray(t)?t:[]}async#s(t){await X.set("reviews",this.#e,t)}async load(){return this.#t()}async save(t){t.id||(t.id=crypto.randomUUID());let e=await this.#t();return e.push(t),await this.#s(e),t}async update(t,e){let s=await this.#t(),r=s.findIndex(i=>i.id===t);if(r===-1)throw new Error(`Pin ${t} not found`);return Object.assign(s[r],e),await this.#s(s),s[r]}async remove(t){let e=(await this.#t()).filter(s=>s.id!==t);await this.#s(e)}},K=class{#e;constructor(t){if(!t)throw new Error("RestAdapter requires an endpoint URL");this.#e=t.replace(/\/$/,"")}async load(){let t=await fetch(this.#e);if(!t.ok)throw new Error(`HTTP ${t.status}`);let e=await t.json();return Array.isArray(e)?e:e.pins||[]}async save(t){let e=await fetch(this.#e,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)});if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()}async update(t,e){let s=await fetch(`${this.#e}/${encodeURIComponent(t)}`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)});if(!s.ok)throw new Error(`HTTP ${s.status}`);return s.json()}async remove(t){let e=await fetch(`${this.#e}/${encodeURIComponent(t)}`,{method:"DELETE"});if(!e.ok)throw new Error(`HTTP ${e.status}`)}},vt=class extends HTMLElement{static get observedAttributes(){return["src","editable","adapter","endpoint","storage-key","author","compact","show-resolved"]}#e=new Map;constructor(){super(),this.attachShadow({mode:"open"}),this.__pins=[],this.__adapter=null,this._activePin=null,this._annotating=!1}get pins(){return this.__pins}set pins(t){let e=Array.isArray(t)?t:[];this.__pins!==e&&(this.__pins=e,this.isConnected&&this._render(),this.dispatchEvent(new CustomEvent("review-surface:pins-changed",{detail:{pins:e,source:"property"},bubbles:!0,composed:!0})))}get adapter(){return this.__adapter}set adapter(t){this.__adapter=t,this.isConnected&&this._loadFromAdapter()}#t(){for(let t of this.children){let e=t.getAttribute("slot");e&&this.#e.set(e,t.textContent.trim())}}_resolve(t){return this.getAttribute(t)||this.#e.get(t)||""}connectedCallback(){this.#t(),this.setAttribute("data-upgraded",""),this.#s(),this.hasAttribute("src")?this._loadSrc(this.getAttribute("src")):this._loadFromAdapter()}disconnectedCallback(){this.removeAttribute("data-upgraded"),this.removeAttribute("data-annotating")}attributeChangedCallback(t){this.isConnected&&(t==="src"?this._loadSrc(this.getAttribute("src")):t==="adapter"||t==="endpoint"||t==="storage-key"?(this.#s(),this._loadFromAdapter()):this._render())}#s(){if(this.__adapter&&!(this.__adapter instanceof P)&&!(this.__adapter instanceof Q)&&!(this.__adapter instanceof K))return;switch(this.getAttribute("adapter")||"memory"){case"local":this.__adapter=new Q(this.getAttribute("storage-key")||"default");break;case"rest":try{this.__adapter=new K(this.getAttribute("endpoint"))}catch{this.__adapter=new P}break;default:this.__adapter=new P}}async _loadSrc(t){if(t){this.shadowRoot.innerHTML=`<style>${Y}</style><div class="state-msg">Loading\u2026</div>`;try{let e=await fetch(t);if(!e.ok)throw new Error(`HTTP ${e.status}`);let s=await e.json();this.__pins=Array.isArray(s)?s:s.pins||[],this._render()}catch(e){this.shadowRoot.innerHTML=`<style>${Y}</style><div class="state-msg state-msg--error">Could not load pins: ${f(e.message)}</div>`}}}async _loadFromAdapter(){if(this.__adapter){try{this.__pins=await this.__adapter.load()}catch{this.__pins=[]}this._render()}}async addPin(t){let e={id:crypto.randomUUID(),x:Math.max(0,Math.min(100,t.x)),y:Math.max(0,Math.min(100,t.y)),text:t.text||"",author:t.author||this.getAttribute("author")||"Anonymous",createdAt:new Date().toISOString(),resolved:!1,resolvedBy:null,resolvedAt:null,replies:[]};return this.__adapter&&await this.__adapter.save(e),this.__pins.push(e),this._render(),this.#l(`Pin ${this.#i().length} added`),this.dispatchEvent(new CustomEvent("review-surface:add",{bubbles:!0,composed:!0,detail:{pin:e}})),e}async removePin(t){let e=this.__pins.find(s=>s.id===t);e&&(this.__adapter&&await this.__adapter.remove(t),this.__pins=this.__pins.filter(s=>s.id!==t),this._activePin===t&&(this._activePin=null),this._render(),this.#l("Pin removed"),this.dispatchEvent(new CustomEvent("review-surface:remove",{bubbles:!0,composed:!0,detail:{pin:e}})))}async resolvePin(t){let e=this.__pins.find(r=>r.id===t);if(!e)return;let s={resolved:!0,resolvedBy:this.getAttribute("author")||"Anonymous",resolvedAt:new Date().toISOString()};this.__adapter&&await this.__adapter.update(t,s),Object.assign(e,s),this._render(),this.#l("Pin resolved"),this.dispatchEvent(new CustomEvent("review-surface:resolve",{bubbles:!0,composed:!0,detail:{pin:e}}))}async unresolvePin(t){let e=this.__pins.find(r=>r.id===t);if(!e)return;let s={resolved:!1,resolvedBy:null,resolvedAt:null};this.__adapter&&await this.__adapter.update(t,s),Object.assign(e,s),this._render(),this.#l("Pin re-opened"),this.dispatchEvent(new CustomEvent("review-surface:update",{bubbles:!0,composed:!0,detail:{pin:e,changes:s}}))}exportPins(){return structuredClone(this.__pins)}importPins(t){this.__pins=Array.isArray(t)?structuredClone(t):[],this._activePin=null,this._render()}#i(){let t=this.hasAttribute("show-resolved");return this.__pins.filter(e=>t||!e.resolved).sort((e,s)=>new Date(e.createdAt)-new Date(s.createdAt))}_render(){let t=this.hasAttribute("editable"),e=this.#i(),s=this._activePin?this.__pins.find(r=>r.id===this._activePin):null;this.setAttribute("pin-count",String(e.length)),this.shadowRoot.innerHTML=`<style>${Y}</style>
    ...
    </div>`}_bindListeners(t){let e=this.shadowRoot;e.querySelectorAll(".rs-pin").forEach(i=>{i.addEventListener("click",a=>{a.stopPropagation();let o=i.dataset.pinId;this._activePin=this._activePin===o?null:o,this._render(),this._activePin&&this.dispatchEvent(new CustomEvent("review-surface:select",{bubbles:!0,composed:!0,detail:{pin:this.__pins.find(n=>n.id===o)}}))})});let s=e.querySelector(".rs-overlay");s&&t&&s.addEventListener("click",i=>{if(!this._annotating||i.target.closest(".rs-pin"))return;let a=s.getBoundingClientRect(),o=(i.clientX-a.left)/a.width*100,n=(i.clientY-a.top)/a.height*100;this.#r(o,n)}),e.querySelectorAll("[data-action]").forEach(i=>{i.addEventListener("click",a=>{a.stopPropagation();let o=i.dataset.action,n=i.dataset.pinId;switch(o){case"close":this._activePin=null,this._render();break;case"resolve":this.resolvePin(n);break;case"unresolve":this.unresolvePin(n);break;case"delete":this.removePin(n);break;case"toggle-mode":this._annotating=!this._annotating,this._annotating?this.setAttribute("data-annotating",""):this.removeAttribute("data-annotating"),this._render(),this.dispatchEvent(new CustomEvent("review-surface:mode",{bubbles:!0,composed:!0,detail:{mode:this._annotating?"annotate":"view"}}));break;case"export":this.#a();break;case"reply":this.#o(n);break}})});let r=e.querySelector(".rs-input__field");r&&r.addEventListener("keydown",i=>{if(i.key==="Enter"&&!i.shiftKey){i.preventDefault();let a=e.querySelector('[data-action="reply"]')?.dataset.pinId;a&&this.#o(a)}}),e.addEventListener("keydown",i=>{i.key==="Escape"&&(this._activePin?(this._activePin=null,this._render()):this._annotating&&(this._annotating=!1,this.removeAttribute("data-annotating"),this._render(),this.dispatchEvent(new CustomEvent("review-surface:mode",{bubbles:!0,composed:!0,detail:{mode:"view"}}))))})}async#r(t,e){let s=this.getAttribute("author")||"Anonymous",r=await this.addPin({x:t,y:e,text:"",author:s});this._activePin=r.id,this._render(),requestAnimationFrame(()=>{let i=this.shadowRoot.querySelector(".rs-input__field");i&&i.focus()})}async#o(t){let e=this.shadowRoot.querySelector(".rs-input__field");if(!e)return;let s=e.value.trim();if(!s)return;let r=this.__pins.find(a=>a.id===t);if(!r)return;let i={id:crypto.randomUUID(),text:s,author:this.getAttribute("author")||"Anonymous",createdAt:new Date().toISOString()};r.replies||(r.replies=[]),r.text?(r.replies.push(i),this.__adapter&&await this.__adapter.update(t,{replies:r.replies})):(r.text=s,this.__adapter&&await this.__adapter.update(t,{text:s})),this._render(),this.#l("Reply added"),requestAnimationFrame(()=>{let a=this.shadowRoot.querySelector(".rs-input__field");a&&a.focus()}),this.dispatchEvent(new CustomEvent("review-surface:update",{bubbles:!0,composed:!0,detail:{pin:r,changes:{replies:r.replies}}}))}async#a(){let t=JSON.stringify(this.exportPins(),null,2);try{await navigator.clipboard.writeText(t),this.#l("Pins copied to clipboard")}catch{let e=new Blob([t],{type:"application/json"}),s=URL.createObjectURL(e),r=document.createElement("a");r.href=s,r.download="review-pins.json",r.click(),URL.revokeObjectURL(s),this.#l("Pins exported as file")}}#n(t){if(!t)return"";try{let e=new Date(t),r=new Date-e,i=Math.floor(r/6e4);if(i<1)return"just now";if(i<60)return`${i}m ago`;let a=Math.floor(i/60);if(a<24)return`${a}h ago`;let o=Math.floor(a/24);return o<7?`${o}d ago`:e.toLocaleDateString()}catch{return""}}#l(t){let e=this.shadowRoot.querySelector(".rs-live");e&&(e.textContent=t)}};x("review-surface",vt);var D=864e5,xt=D*7,G=D*30,re=D*91,Pt=D*365;function R(c){return typeof c=="number"?c:new Date(c).getTime()}function ie(c){return c<=xt*3?t=>t.toLocaleDateString(void 0,{month:"short",day:"numeric"}):c<=G*3?t=>t.toLocaleDateString(void 0,{month:"short",day:"numeric"}):c<=Pt?t=>t.toLocaleDateString(void 0,{month:"short",year:"2-digit"}):t=>t.toLocaleDateString(void 0,{year:"numeric"})}function ae(c){return c<=xt*3?"day":c<=G*3?"week":c<=Pt?"month":"quarter"}function jt(c){return String(c).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}var yt=class c extends C{static get observedAttributes(){return["src","title","view","show-today","show-progress","show-dependencies","compact"]}#e=null;#t=null;#s=null;#i=[];#r=0;#o=0;#a=0;setup(){let t=this.querySelector(":scope > table");if(!t||(this.#i=this.#c(t),this.#i.length===0))return!1;this.#r=Math.min(...this.#i.map(e=>e.start)),this.#o=Math.max(...this.#i.map(e=>e.end)),this.#a=this.#o-this.#r,this.#a<=0&&(this.#a=D),this.#p(t),this.dispatchEvent(new CustomEvent("gantt-chart:ready",{bubbles:!0,detail:{taskCount:this.#i.length,dateRange:{start:new Date(this.#r).toISOString(),end:new Date(this.#o).toISOString()}}}))}teardown(){this.#s&&(this.#s.remove(),this.#s=null),this.#e&&(this.#e.remove(),this.#e=null),this.#t&&(this.#t.remove(),this.#t=null);let t=this.querySelector("table.gc-sr-only");t&&t.classList.remove("gc-sr-only"),this.#i=[]}static#n=0;attributeChangedCallback(t,e,s){e===s||!this.isConnected||(t==="src"?this._loadSrc(s):this.hasAttribute("data-upgraded")&&this.#l())}#l(){let t=()=>{this.teardown(),this.removeAttribute("data-upgraded"),this.setup()};if(this.hasAttribute("data-upgraded")&&"startViewTransition"in document&&!matchMedia("(prefers-reduced-motion: reduce)").matches){let e=`gc-vt-${++c.#n}`;this.style.viewTransitionName=e,document.startViewTransition(t).finished.finally(()=>{this.style.viewTransitionName=""})}else t()}get tasks(){return this.#i}set tasks(t){let e=(t||[]).map((s,r)=>({id:s.id??`gc-task-${r}`,name:s.name??`Task ${r+1}`,start:typeof s.start=="number"?s.start:R(s.start),end:typeof s.end=="number"?s.end:s.end!=null?R(s.end):typeof s.start=="number"?s.start:R(s.start),progress:s.progress??0,group:s.group??null,depends:Array.isArray(s.depends)?s.depends:s.depends?String(s.depends).split(",").map(i=>i.trim()):[],status:s.status??null,assignee:s.assignee??null,milestone:!!s.milestone,color:s.color??null,storyIds:s.storyIds??[],itemIds:s.itemIds??[]}));if((this.#e||this.#s||this.#t)&&(this.#s&&(this.#s.remove(),this.#s=null),this.#e&&(this.#e.remove(),this.#e=null),this.#t&&(this.#t.remove(),this.#t=null)),this.#i=e,e.length>0){this.#r=Math.min(...e.map(r=>r.start)),this.#o=Math.max(...e.map(r=>r.end)),this.#a=this.#o-this.#r,this.#a<=0&&(this.#a=D);let s=this.querySelector(":scope > table");s||(s=document.createElement("table"),s.classList.add("gc-sr-only"),this.appendChild(s)),this.#p(s)}this.dispatchEvent(new CustomEvent("gantt-chart:tasks-changed",{detail:{tasks:e,source:"property"},bubbles:!0}))}#c(t){let e=t.querySelectorAll("tbody tr"),s=[];for(let r=0;r<e.length;r++){let i=e[r],a=i.querySelectorAll("time[datetime]");if(a.length<2&&!i.hasAttribute("data-milestone"))continue;let o=a[0]?.getAttribute("datetime"),n=a.length>1?a[1].getAttribute("datetime"):o;if(!o)continue;let d=i.querySelector("progress"),l=d?d.value/(d.max||100):0,h=i.cells[0]?.textContent?.trim()||`Task ${r+1}`;s.push({id:i.dataset.taskId||`gc-task-${r}`,name:h,start:R(o),end:R(n),progress:l,group:i.dataset.group||null,depends:i.dataset.depends?i.dataset.depends.split(",").map(u=>u.trim()):[],status:i.dataset.status||null,assignee:i.dataset.assignee||null,milestone:i.hasAttribute("data-milestone"),color:i.dataset.color||null,storyIds:i.dataset.storyIds?i.dataset.storyIds.split(",").map(u=>u.trim()):[],itemIds:i.dataset.itemIds?i.dataset.itemIds.split(",").map(u=>u.trim()):[]})}return s}#p(t){let e=this.getAttribute("title"),s=this.hasAttribute("show-today"),r=this.hasAttribute("show-progress"),i=this.hasAttribute("show-dependencies");e&&(this.#s=document.createElement("h2"),this.#s.className="gc-title",this.#s.textContent=e,this.insertBefore(this.#s,t)),this.#e=document.createElement("div"),this.#e.className="gc-container",this.#e.setAttribute("role","region"),this.#e.setAttribute("aria-label",`Gantt chart${e?": "+e:""}`);let a=this.#d();this.#e.appendChild(a);let o=document.createElement("div");o.className="gc-body";let n=document.createElement("div");n.className="gc-task-list";let d=document.createElement("div");d.className="gc-bars";let l=this.#f();d.appendChild(l);let h=this.#x();for(let[u,m]of h){if(h.size>1&&u){let b=document.createElement("div");b.className="gc-group-header";let p=document.createElement("span");p.className="gc-group-label",p.textContent=u,b.appendChild(p),n.appendChild(b);let g=document.createElement("div");g.className="gc-group-spacer",d.appendChild(g)}for(let b of m){let p=document.createElement("div");p.className="gc-task-row",p.setAttribute("data-task-id",b.id);let g=document.createElement("span");g.className="gc-task-name",g.textContent=b.name,p.appendChild(g);let v=document.createElement("span");v.className="gc-task-dates",v.textContent=`${new Date(b.start).toLocaleDateString()} to ${new Date(b.end).toLocaleDateString()}`,p.appendChild(v),n.appendChild(p);let w=document.createElement("div");w.className="gc-bar-row",b.milestone?w.appendChild(this.#b(b)):w.appendChild(this.#u(b,r)),d.appendChild(w)}}if(s){let u=this.#w();u&&d.appendChild(u)}i&&requestAnimationFrame(()=>{let u=this.#g(d);u&&d.appendChild(u)}),o.appendChild(n),o.appendChild(d),this.#e.appendChild(o),this.insertBefore(this.#e,t),t.classList.add("gc-sr-only"),this.#t=document.createElement("div"),this.#t.className="gc-sr-only",this.#t.setAttribute("role","status"),this.#t.setAttribute("aria-live","polite"),this.#t.setAttribute("aria-atomic","true"),this.appendChild(this.#t),this.listen(this.#e,"click",u=>{let m=u.target.closest(".gc-bar, .gc-milestone");if(!m)return;let b=m.dataset.taskId,p=this.#i.find(g=>g.id===b);p&&(this.#m(`Selected: ${p.name}`),this.dispatchEvent(new CustomEvent("gantt-chart:task-click",{bubbles:!0,detail:{task:p}})))}),this.listen(this.#e,"keydown",u=>{if(u.key==="Enter"||u.key===" "){let m=u.target.closest(".gc-bar, .gc-milestone");m&&(u.preventDefault(),m.click())}})}#d(){let t=document.createElement("div");t.className="gc-timeline-header";let e=document.createElement("div");e.className="gc-timeline-spacer",t.appendChild(e);let s=document.createElement("div");s.className="gc-timeline-dates";let r=this.#h();for(let{position:i,text:a}of r){let o=document.createElement("span");o.className="gc-date-label",o.style.left=`${i}%`,o.textContent=a,s.appendChild(o)}return t.appendChild(s),t}#h(){let t=this.getAttribute("view")||"auto",e=t==="auto"?ae(this.#a):t,s=ie(this.#a),r=[],i;switch(e){case"day":i=D;break;case"week":i=xt;break;case"month":i=G;break;case"quarter":i=re;break;default:i=G}let a=new Date(this.#r);if(e==="week"){let d=a.getDay(),l=d===0?1:d===1?0:8-d;a.setDate(a.getDate()+l)}else if(e==="month")a.setDate(1),a.getTime()<this.#r&&a.setMonth(a.getMonth()+1);else if(e==="quarter"){let d=a.getMonth(),l=Math.ceil((d+1)/3)*3;a.setMonth(l),a.setDate(1)}let o=a.getTime();o>this.#r+i*.5&&r.push({position:0,text:s(new Date(this.#r))});let n=o;for(;n<=this.#o;){let d=(n-this.#r)/this.#a*100;if(d>=0&&d<=100&&r.push({position:d,text:s(new Date(n))}),e==="month"){let l=new Date(n);l.setMonth(l.getMonth()+1),n=l.getTime()}else if(e==="quarter"){let l=new Date(n);l.setMonth(l.getMonth()+3),n=l.getTime()}else n+=i}return r}#f(){let t=document.createElement("div");t.className="gc-grid-lines";let e=this.#h();for(let{position:s}of e){if(s<=0)continue;let r=document.createElement("div");r.className="gc-grid-line",r.style.left=`${s}%`,t.appendChild(r)}return t}#x(){let t=new Map;for(let e of this.#i){let s=e.group||"";t.has(s)||t.set(s,[]),t.get(s).push(e)}return t}#u(t,e){let s=(t.start-this.#r)/this.#a*100,r=(t.end-t.start)/this.#a*100,i=document.createElement("div");if(i.className="gc-bar",i.setAttribute("data-task-id",t.id),i.setAttribute("role","img"),i.setAttribute("tabindex","0"),i.setAttribute("aria-label",`${jt(t.name)}: ${new Date(t.start).toLocaleDateString()} to ${new Date(t.end).toLocaleDateString()}`+(t.progress>0?`, ${Math.round(t.progress*100)}% complete`:"")),i.style.left=`${s}%`,i.style.width=`${Math.max(r,.5)}%`,t.status&&i.setAttribute("data-status",t.status),t.color&&i.style.setProperty("--gc-bar-color",t.color),e&&t.progress>0){let a=document.createElement("div");a.className="gc-bar-fill",a.style.width=`${Math.round(t.progress*100)}%`,i.appendChild(a)}if(r>8){let a=document.createElement("span");a.className="gc-bar-label",a.textContent=t.name,i.appendChild(a)}return i}#b(t){let e=(t.start-this.#r)/this.#a*100,s=document.createElement("div");return s.className="gc-milestone",s.setAttribute("data-task-id",t.id),s.setAttribute("role","img"),s.setAttribute("tabindex","0"),s.setAttribute("aria-label",`Milestone: ${jt(t.name)}, ${new Date(t.start).toLocaleDateString()}`),s.style.left=`${e}%`,t.status&&s.setAttribute("data-status",t.status),t.color&&s.style.setProperty("--gc-bar-color",t.color),s}#w(){let t=Date.now();if(t<this.#r||t>this.#o)return null;let e=(t-this.#r)/this.#a*100,s=document.createElement("div");s.className="gc-today-line",s.style.left=`${e}%`;let r=document.createElement("span");return r.className="gc-today-label",r.textContent="Today",s.appendChild(r),s}#g(t){if(!this.#i.some(n=>n.depends.length>0))return null;let s="http://www.w3.org/2000/svg",r=document.createElementNS(s,"svg");r.setAttribute("class","gc-deps"),r.style.width="100%",r.style.height="100%";let i=document.createElementNS(s,"defs"),a=document.createElementNS(s,"marker");a.setAttribute("id","gc-arrowhead"),a.setAttribute("markerWidth","8"),a.setAttribute("markerHeight","6"),a.setAttribute("refX","8"),a.setAttribute("refY","3"),a.setAttribute("orient","auto");let o=document.createElementNS(s,"polygon");o.setAttribute("points","0 0, 8 3, 0 6"),o.setAttribute("fill","var(--color-text-muted, #666666)"),a.appendChild(o),i.appendChild(a),r.appendChild(i);for(let n of this.#i)for(let d of n.depends){let l=this.#i.find(_=>_.id===d);if(!l)continue;let h=(l.end-this.#r)/this.#a*100,u=(n.start-this.#r)/this.#a*100,m=this.#v(l.id,t),b=this.#v(n.id,t);if(m===-1||b===-1)continue;let p=36,g=m*p+p/2,v=b*p+p/2,w=document.createElementNS(s,"path"),y=h+(u-h)/2;w.setAttribute("d",`M ${h}% ${g} C ${y}% ${g}, ${y}% ${v}, ${u}% ${v}`),w.setAttribute("class","gc-dep-line"),r.appendChild(w)}return r}#v(t,e){let s=e.querySelectorAll(".gc-bar-row");for(let r=0;r<s.length;r++){let i=s[r].querySelector("[data-task-id]");if(i&&i.dataset.taskId===t)return r}return-1}async _loadSrc(t){if(t)try{let e=await fetch(t);if(!e.ok)throw new Error(`HTTP ${e.status}`);let s=await e.json();for(;this.firstChild;)this.firstChild.remove();let r=document.createElement("table"),i=document.createElement("thead"),a=document.createElement("tr");for(let n of["Task","Start","End","Progress"]){let d=document.createElement("th");d.textContent=n,a.appendChild(d)}i.appendChild(a),r.appendChild(i);let o=document.createElement("tbody");for(let n of s.tasks||[]){let d=document.createElement("tr");n.id&&(d.dataset.taskId=n.id),n.group&&(d.dataset.group=n.group),n.depends&&(d.dataset.depends=Array.isArray(n.depends)?n.depends.join(","):n.depends),n.status&&(d.dataset.status=n.status),n.assignee&&(d.dataset.assignee=n.assignee),n.milestone&&d.setAttribute("data-milestone",""),n.color&&(d.dataset.color=n.color),n.storyIds&&(d.dataset.storyIds=Array.isArray(n.storyIds)?n.storyIds.join(","):n.storyIds),n.itemIds&&(d.dataset.itemIds=Array.isArray(n.itemIds)?n.itemIds.join(","):n.itemIds);let l=document.createElement("td");l.textContent=n.name||"",d.appendChild(l);let h=document.createElement("td"),u=document.createElement("time");u.setAttribute("datetime",n.start),u.textContent=new Date(n.start).toLocaleDateString(void 0,{month:"short",day:"numeric"}),h.appendChild(u),d.appendChild(h);let m=document.createElement("td"),b=document.createElement("time");b.setAttribute("datetime",n.end||n.start),b.textContent=new Date(n.end||n.start).toLocaleDateString(void 0,{month:"short",day:"numeric"}),m.appendChild(b),d.appendChild(m);let p=document.createElement("td"),g=document.createElement("progress");g.value=n.progress||0,g.max=100,g.textContent=`${n.progress||0}%`,p.appendChild(g),d.appendChild(p),o.appendChild(d)}r.appendChild(o),this.appendChild(r),s.title&&this.setAttribute("title",s.title),this.#l()}catch(e){console.warn(`[gantt-chart] Failed to load src="${t}":`,e)}}#m(t){this.#t&&(this.#t.textContent="",requestAnimationFrame(()=>{this.#t&&(this.#t.textContent=t)}))}};x("gantt-chart",yt);var wt=class c extends C{static get observedAttributes(){return["src","compact","title","searchable"]}static#e=0;#t=null;#s=null;#i=null;#r=null;#o=null;#a="";#n=null;#l=[];#c=[];#p=new Map;#d=new Map;setup(){this.#a=`gloss-${++c.#e}`;let t=this.querySelector(":scope > dl");if(!t)return!1;let e=[...t.querySelectorAll(":scope > div[data-term-id]")];if(e.length===0)return!1;this.#l=e.map(i=>{let a=i.getAttribute("data-term-id")||"",o=i.getAttribute("data-category")||"Uncategorized",n=i.querySelector("dt"),d=i.querySelector("dd"),l=n?n.textContent.trim():"",h=d?d.textContent.trim():"";return i.id=a,{id:a,term:l,definition:h,category:o,el:i}});let s=new Set;this.#c=[];for(let i of this.#l)s.has(i.category)||(s.add(i.category),this.#c.push(i.category));t.remove(),this.#h();let r=this.getAttribute("src");if(r){this._loadSrc(r);return}this.dispatchEvent(new CustomEvent("glossary-wc:ready",{bubbles:!0,detail:{termCount:this.#l.length,categories:[...this.#c]}}))}get terms(){return this.#l.map(t=>({id:t.id,term:t.term,definition:t.definition,category:t.category}))}set terms(t){let e=Array.isArray(t)?t:[];for(;this.firstChild;)this.firstChild.remove();let s=document.createElement("dl");for(let r of e){let i=document.createElement("div");i.setAttribute("data-term-id",r.id||""),r.category&&i.setAttribute("data-category",r.category);let a=document.createElement("dt");a.textContent=r.term||"";let o=document.createElement("dd");o.textContent=r.definition||"",i.appendChild(a),i.appendChild(o),s.appendChild(i)}this.appendChild(s),this.teardown(),this.removeAttribute("data-upgraded"),this.setup(),this.dispatchEvent(new CustomEvent("glossary-wc:terms-changed",{detail:{terms:e,source:"property"},bubbles:!0}))}teardown(){this.#n&&clearTimeout(this.#n);let t=this.querySelector(".gloss-title");t&&t.remove(),this.#t?.parentElement&&this.#t.parentElement.remove(),this.#s&&this.#s.remove(),this.#o&&this.#o.remove(),this.#r&&this.#r.remove(),this.#t=null,this.#s=null,this.#i=null,this.#r=null,this.#o=null,this.#l=[],this.#c=[],this.#p=new Map,this.#d=new Map}#h(){let t=this.getAttribute("title");if(t){let e=document.createElement("h2");e.className="gloss-title",e.textContent=t,this.#i=document.createElement("output"),this.#i.className="gloss-count",this.#i.textContent=String(this.#l.length),e.appendChild(this.#i),this.appendChild(e)}if(this.hasAttribute("searchable")){let e=document.createElement("div");e.className="gloss-search";let s=document.createElement("input");s.type="search",s.className="gloss-search-input",s.setAttribute("placeholder","Search terms\u2026"),s.setAttribute("aria-label","Search glossary terms"),e.appendChild(s),this.appendChild(e),this.#t=s,this.listen(s,"input",this.#u)}this.#f(),this.#o=document.createElement("div"),this.#o.className="gloss-categories",this.#o.setAttribute("role","region"),this.#o.setAttribute("aria-label","Glossary terms"),this.appendChild(this.#o);for(let e of this.#c){let s=this.#l.filter(r=>r.category===e);this.#x(e,s)}this.#r=document.createElement("div"),this.#r.className="gloss-live-region",this.#r.setAttribute("role","status"),this.#r.setAttribute("aria-live","polite"),this.#r.setAttribute("aria-atomic","true"),this.appendChild(this.#r)}#f(){this.#s=document.createElement("nav"),this.#s.className="gloss-jump-bar",this.#s.setAttribute("aria-label","Alphabet navigation");let t=new Set;for(let e of this.#l){let s=e.term.charAt(0).toUpperCase();/[A-Z]/.test(s)&&t.add(s)}for(let e=65;e<=90;e++){let s=String.fromCharCode(e),r=document.createElement("a");r.textContent=s,r.className="gloss-jump-letter",t.has(s)?(r.href=`#${this.#a}-letter-${s}`,r.setAttribute("data-active","")):(r.setAttribute("aria-disabled","true"),r.setAttribute("tabindex","-1")),this.#s.appendChild(r)}this.appendChild(this.#s)}#x(t,e){let s=document.createElement("section");s.className="gloss-category",s.setAttribute("data-category",t);let r=document.createElement("header");r.className="gloss-category-header";let i=document.createElement("button");i.type="button",i.className="gloss-category-toggle",i.setAttribute("aria-expanded","true"),i.innerHTML=`<span class="gloss-category-label">${f(t)}</span><output class="gloss-category-count">${e.length}</output><span class="gloss-chevron" aria-hidden="true"></span>`,r.appendChild(i),s.appendChild(r),this.#p.set(t,i);let a=document.createElement("dl");a.className="gloss-term-list";let o=[...e].sort((l,h)=>l.term.localeCompare(h.term)),n=[],d="";for(let l of o){let h=l.term.charAt(0).toUpperCase();if(/[A-Z]/.test(h)&&h!==d){d=h;let u=document.createElement("span");u.id=`${this.#a}-letter-${h}`,u.className="gloss-letter-anchor",a.appendChild(u)}l.el.className="gloss-term",l.el.id=l.id,a.appendChild(l.el),n.push(l.el)}this.#d.set(t,n),s.appendChild(a),this.#o.appendChild(s),this.listen(i,"click",()=>{let l=i.getAttribute("aria-expanded")==="true";i.setAttribute("aria-expanded",String(!l)),a.hidden=l})}#u=t=>{this.#n&&clearTimeout(this.#n),this.#n=setTimeout(()=>{let e=t.target.value.toLowerCase().trim();this.#b(e)},150)};#b(t){let e=0;for(let s of this.#l)t===""||s.term.toLowerCase().includes(t)||s.definition.toLowerCase().includes(t)?(s.el.removeAttribute("hidden"),e++):s.el.setAttribute("hidden","");for(let s of this.#c){let r=this.#d.get(s)||[],i=r[0]?.closest(".gloss-category");if(!i)continue;if(r.some(o=>!o.hasAttribute("hidden"))){i.removeAttribute("hidden");let o=r.filter(d=>!d.hasAttribute("hidden")).length,n=i.querySelector(".gloss-category-count");n&&(n.textContent=String(o))}else i.setAttribute("hidden","")}this.#i&&(this.#i.textContent=t===""?String(this.#l.length):`${e} / ${this.#l.length}`),t!==""&&this.#r&&(this.#r.textContent="",requestAnimationFrame(()=>{this.#r&&(this.#r.textContent=`${e} term${e!==1?"s":""} found`)})),this.dispatchEvent(new CustomEvent("glossary-wc:search",{bubbles:!0,detail:{query:t,matchCount:e}}))}attributeChangedCallback(t,e,s){e===s||!this.isConnected||t==="src"&&this._loadSrc(s)}async _loadSrc(t){if(t)try{let e=await fetch(t);if(!e.ok)throw new Error(`HTTP ${e.status}`);let s=await e.json();for(;this.firstChild;)this.firstChild.remove();let r=document.createElement("dl");for(let i of s.terms||[]){let a=document.createElement("div");a.setAttribute("data-term-id",i.id||""),a.setAttribute("data-category",i.category||"Uncategorized");let o=document.createElement("dt");o.textContent=i.term||"";let n=document.createElement("dd"),d=i.definition||"";if(i.seeAlso&&i.seeAlso.length>0){let l=i.seeAlso.map(h=>`<a href="#${f(h)}">${f(this.#w(h))}</a>`).join(", ");d+=` See also: ${l}.`}n.innerHTML=d,a.appendChild(o),a.appendChild(n),r.appendChild(a)}this.appendChild(r),s.title&&!this.getAttribute("title")&&this.setAttribute("title",s.title),this.teardown(),this.removeAttribute("data-upgraded"),this.setup()}catch(e){console.warn(`[glossary-wc] Failed to load src="${t}":`,e)}}#w(t){return t.replace(/[-_]/g," ").replace(/\b\w/g,e=>e.toUpperCase())}};x("glossary-wc",wt);var B=`
:host {
...
`;var Rt={task:'<rect x="3" y="3" width="18" height="18" rx="2"/><path d="m9 12 2 2 4-4"/>',bug:'<path d="m8 2 1.88 1.88"/><path d="M14.12 3.88 16 2"/><path d="M9 7.13v-1a3.003 3.003 0 1 1 6 0v1"/><path d="M12 20c-3.3 0-6-2.7-6-6v-3a4 4 0 0 1 4-4h4a4 4 0 0 1 4 4v3c0 3.3-2.7 6-6 6"/><path d="M12 20v-9"/><path d="M6.53 9C4.6 8.8 3 7.1 3 5"/><path d="M6 13H2"/><path d="M3 21c0-2.1 1.7-3.9 3.8-4"/><path d="M20.97 5c0 2.1-1.6 3.8-3.5 4"/><path d="M22 13h-4"/><path d="M17.2 17c2.1.1 3.8 1.9 3.8 4"/>',chore:'<path d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.106-3.105c.32-.322.863-.22.983.218a6 6 0 0 1-8.259 7.057l-7.91 7.91a1 1 0 0 1-2.999-3l7.91-7.91a6 6 0 0 1 7.057-8.259c.438.12.54.662.219.984z"/>',spike:'<path d="M15 14c.2-1 .7-1.7 1.5-2.5 1-.9 1.5-2.2 1.5-3.5A6 6 0 0 0 6 8c0 1 .2 2.2 1.5 3.5.7.7 1.3 1.5 1.5 2.5"/><path d="M9 18h6"/><path d="M10 22h4"/>',feature:'<circle cx="12" cy="12" r="10"/><path d="m9 12 2 2 4-4"/>'},_t={critical:{label:"Critical",color:"#dc2626",bg:"rgba(220, 38, 38, 0.1)"},high:{label:"High",color:"#ea580c",bg:"rgba(234, 88, 12, 0.1)"},medium:{label:"Medium",color:"#ca8a04",bg:"rgba(202, 138, 4, 0.1)"},low:{label:"Low",color:"#16a34a",bg:"rgba(22, 163, 74, 0.1)"}},At={backlog:{label:"Backlog",color:"#6b7280",bg:"rgba(107, 114, 128, 0.1)"},"to-do":{label:"To Do",color:"#3b82f6",bg:"rgba(59, 130, 246, 0.1)"},"in-progress":{label:"In Progress",color:"#8b5cf6",bg:"rgba(139, 92, 246, 0.1)"},review:{label:"Review",color:"#f59e0b",bg:"rgba(245, 158, 11, 0.1)"},done:{label:"Done",color:"#22c55e",bg:"rgba(34, 197, 94, 0.1)"},blocked:{label:"Blocked",color:"#dc2626",bg:"rgba(220, 38, 38, 0.1)"}},Ct=class extends HTMLElement{static get observedAttributes(){return["item-id","type","priority","status","estimate","assignee","story-ids","detail","compact","src"]}#e=new Map;constructor(){super(),this.attachShadow({mode:"open"})}#t(){for(let t of[...this.children]){let e=t.getAttribute("slot");e&&this.#e.set(e,t.textContent.trim())}}_resolve(t){return this.getAttribute(t)||this.#e.get(t)||""}connectedCallback(){this.#t(),this.itemId&&!this.id&&(this.id=this.itemId),this.hasAttribute("src")&&this._loadSrc(this.getAttribute("src")),this.#s(),this.setAttribute("data-upgraded","")}disconnectedCallback(){this.removeAttribute("data-upgraded")}attributeChangedCallback(t,e,s){e!==s&&this.shadowRoot&&(t==="src"&&this.isConnected?this._loadSrc(s):this.#s())}get itemId(){return this.getAttribute("item-id")||""}get itemTitle(){return this.querySelector('[slot="title"]')?.textContent?.trim()||this.#e.get("title")||""}get itemType(){return this.getAttribute("type")||"task"}get priority(){return this.getAttribute("priority")||"medium"}get status(){return this.getAttribute("status")||"backlog"}get estimate(){return this.getAttribute("estimate")||""}get assignee(){return this.getAttribute("assignee")||""}get storyIds(){let t=this.getAttribute("story-ids")||"";return t?t.split(",").map(e=>e.trim()).filter(Boolean):[]}get _detailLevel(){return this.getAttribute("detail")?this.getAttribute("detail"):this.hasAttribute("compact")?"compact":"full"}get _minimalLabel(){return this.itemTitle||this.itemId||"Work item"}updateStatus(t){At[t]&&(this.setAttribute("status",t),this.dispatchEvent(new CustomEvent("work-item:status",{detail:{status:t,itemId:this.itemId},bubbles:!0,composed:!0})))}updatePriority(t){_t[t]&&(this.setAttribute("priority",t),this.dispatchEvent(new CustomEvent("work-item:priority",{detail:{priority:t,itemId:this.itemId},bubbles:!0,composed:!0})))}get data(){return{itemId:this.itemId||void 0,type:this.itemType,priority:this.priority,status:this.status,estimate:this.estimate||void 0,assignee:this.assignee||void 0,storyIds:this.storyIds.length?this.storyIds:void 0,detail:this.getAttribute("detail")||void 0,title:this.itemTitle||void 0}}set data(t){!t||typeof t!="object"||(this._applyData(t),this.shadowRoot&&this.#s(),this.dispatchEvent(new CustomEvent("work-item:data-changed",{detail:{data:this.data,source:"property"},bubbles:!0,composed:!0})))}_applyData(t){for(let[e,s]of[["itemId","item-id"],["type","type"],["priority","priority"],["status","status"],["estimate","estimate"],["assignee","assignee"],["detail","detail"]])t[e]!=null&&this.setAttribute(s,String(t[e]));if(t.storyIds&&this.setAttribute("story-ids",Array.isArray(t.storyIds)?t.storyIds.join(","):t.storyIds),t.title&&!this.querySelector('[slot="title"]')){let e=document.createElement("h3");e.slot="title",e.textContent=t.title,this.appendChild(e)}for(let e of["description","notes"])if(t[e]&&!this.querySelector(`[slot="${e}"]`)){let s=document.createElement("p");s.slot=e,s.textContent=t[e],this.appendChild(s)}if(t.checklist&&!this.querySelector('[slot="checklist"]')){let e=document.createElement("ul");e.slot="checklist";let s=Array.isArray(t.checklist)?t.checklist:[t.checklist];for(let r of s){let i=document.createElement("li");i.textContent=r,e.appendChild(i)}this.appendChild(e)}}async _loadSrc(t){if(t){this.shadowRoot.innerHTML=`<style>${B}</style><div class="state-msg">Loading\u2026</div>`;try{let e=await fetch(t);if(!e.ok)throw new Error(`HTTP ${e.status}`);let s=await e.json();this._applyData(s),this.#s()}catch(e){this.shadowRoot.innerHTML=`<style>${B}</style><div class="state-msg state-msg--error">Could not load: ${f(e.message)}</div>`}}}#s(){let t=_t[this.priority]||_t.medium,e=At[this.status]||At.backlog,s=this.itemType,r=Rt[s]||Rt.task,i=this._detailLevel,a=this.itemId?`Work item: ${f(this.itemId)}`:"Work item";if(i==="minimal"){this.shadowRoot.innerHTML=`<style>${B}</style>
      ...
      </article>`,i==="compact")for(let o of this.shadowRoot.querySelectorAll(".wi-section")){let n=o.querySelector("slot");n&&n.assignedNodes().length===0&&o.setAttribute("data-empty","")}this.dispatchEvent(new CustomEvent("work-item:ready",{detail:{itemId:this.itemId,title:this.itemTitle,type:s,priority:this.priority,status:this.status},bubbles:!0,composed:!0}))}};x("work-item",Ct);var J={layout:{label:"Layout",cssClass:"sm-badge--layout"},section:{label:"Section",cssClass:"sm-badge--section"},dashboard:{label:"Dashboard",cssClass:"sm-badge--dashboard"},page:{label:"Page",cssClass:"sm-badge--page"},modal:{label:"Modal",cssClass:"sm-badge--modal"},redirect:{label:"Redirect",cssClass:"sm-badge--redirect"}},Z={draft:{label:"Draft",cssClass:"sm-status--draft"},ready:{label:"Ready",cssClass:"sm-status--ready"},live:{label:"Live",cssClass:"sm-status--live"},deprecated:{label:"Deprecated",cssClass:"sm-status--deprecated"}},kt=class c extends C{static get observedAttributes(){return["src","collapsed","compact","title","data-view","data-orientation","data-detail"]}static#e=0;#t=null;#s=null;#i=null;#r=null;#o=0;#a=0;setup(){c.#e++;let t=this.getAttribute("src");if(t&&!this.querySelector("nav")){this._loadSrc(t);return}let e=this.querySelector(":scope > nav");if(e){if(this.#o=0,this.#a=0,this.#n(e.querySelector("ul"),0),this.dataset.view==="visual"){this.#c(),this.#Z(e),this.dispatchEvent(new CustomEvent("site-map-wc:ready",{bubbles:!0,detail:{nodeCount:this.#o,depth:this.#a}}));return}this.#l(e.querySelector("ul"),0),this.#c(),e.classList.add("sm-tree"),e.setAttribute("role","tree"),e.setAttribute("aria-label",this.getAttribute("title")||"Site map"),this.#t=e,this.hasAttribute("collapsed")&&this.#p(),this.listen(e,"keydown",s=>this.#x(s)),this.listen(e,"click",s=>this.#f(s)),this.dispatchEvent(new CustomEvent("site-map-wc:ready",{bubbles:!0,detail:{nodeCount:this.#o,depth:this.#a}}))}}teardown(){if(this.#i){this.#i.remove(),this.#i=null;let t=this.querySelector("nav");t&&(t.style.display="",t.removeAttribute("aria-hidden"))}this.#s&&(this.#s.remove(),this.#s=null),this.#t&&(this.#t.classList.remove("sm-tree"),this.#t.removeAttribute("role"),this.#t.removeAttribute("aria-label")),this.querySelectorAll(".sm-node-content, .sm-toggle").forEach(t=>t.remove()),this.querySelectorAll('li[role="treeitem"]').forEach(t=>{t.removeAttribute("role"),t.removeAttribute("aria-expanded"),t.removeAttribute("tabindex")}),this.querySelectorAll('ul[role="group"]').forEach(t=>{t.removeAttribute("role"),t.classList.remove("sm-subtree","sm-collapsed")}),this.#t=null,this.#r=null,this.#o=0,this.#a=0}attributeChangedCallback(t,e,s){e===s||!this.isConnected||t==="src"&&this._loadSrc(s)}#n(t,e){if(!t)return;let s=t.querySelectorAll(":scope > li");for(let r of s){this.#o++;let i=e+1;i>this.#a&&(this.#a=i);let a=r.querySelector(":scope > ul");a&&this.#n(a,i)}}#l(t,e){if(!t)return;e>0&&(t.setAttribute("role","group"),t.classList.add("sm-subtree"));let s=[...t.querySelectorAll(":scope > li")];for(let r of s){let i=!!r.querySelector(":scope > ul"),a=r.querySelector(":scope > a"),o=r.getAttribute("data-page-type")||"page",n=r.getAttribute("data-template")||"",d=r.getAttribute("data-status")||"";r.setAttribute("role","treeitem"),r.setAttribute("tabindex","-1");let l=document.createElement("span");if(l.className="sm-node-content",i){r.setAttribute("aria-expanded","true");let u=document.createElement("button");u.className="sm-toggle",u.setAttribute("type","button"),u.setAttribute("aria-hidden","true"),u.setAttribute("tabindex","-1"),u.textContent="\u25BE",l.appendChild(u)}else{let u=document.createElement("span");u.className="sm-leaf-marker",u.setAttribute("aria-hidden","true"),l.appendChild(u)}if(d&&Z[d]){let u=document.createElement("span");u.className=`sm-status-dot ${Z[d].cssClass}`,u.setAttribute("title",Z[d].label),u.setAttribute("aria-label",Z[d].label),l.appendChild(u)}if(a&&l.appendChild(a),J[o]){let u=document.createElement("span");u.className=`sm-badge ${J[o].cssClass}`,u.textContent=J[o].label,l.appendChild(u)}if(n){let u=document.createElement("span");u.className="sm-badge sm-badge--template",u.textContent=n,l.appendChild(u)}r.insertBefore(l,r.firstChild);let h=r.querySelector(":scope > ul");h&&this.#l(h,e+1)}}#c(){let t=this.getAttribute("title");if(!t&&this.#o===0)return;if(this.#s=document.createElement("div"),this.#s.className="sm-header",t){let r=document.createElement("h2");r.className="sm-title",r.textContent=t,this.#s.appendChild(r)}let e=document.createElement("span");e.className="sm-summary",e.textContent=`${this.#o} pages \xB7 ${this.#a} levels deep`,this.#s.appendChild(e);let s=document.createElement("button");s.className="sm-toggle-all",s.setAttribute("type","button"),s.textContent="Collapse all",s.addEventListener("click",()=>{this.querySelectorAll('li[aria-expanded="true"]').length>0?(this.#p(),s.textContent="Expand all"):(this.#d(),s.textContent="Collapse all")}),this.#s.appendChild(s),this.insertBefore(this.#s,this.firstChild)}#p(){let t=this.querySelectorAll("li[aria-expanded]");for(let e of t){e.setAttribute("aria-expanded","false");let s=e.querySelector(":scope > ul");s&&s.classList.add("sm-collapsed");let r=e.querySelector(":scope > .sm-node-content > .sm-toggle");r&&(r.textContent="\u25B8")}}#d(){let t=this.querySelectorAll("li[aria-expanded]");for(let e of t){e.setAttribute("aria-expanded","true");let s=e.querySelector(":scope > ul");s&&s.classList.remove("sm-collapsed");let r=e.querySelector(":scope > .sm-node-content > .sm-toggle");r&&(r.textContent="\u25BE")}}#h(t){let e=t.getAttribute("aria-expanded")==="true";t.setAttribute("aria-expanded",e?"false":"true");let s=t.querySelector(":scope > ul");s&&s.classList.toggle("sm-collapsed",e);let r=t.querySelector(":scope > .sm-node-content > .sm-toggle");r&&(r.textContent=e?"\u25B8":"\u25BE")}#f(t){let e=t.target;if(e.closest(".sm-toggle")){t.preventDefault();let i=e.closest('li[role="treeitem"]');i&&this.#h(i);return}let s=e.closest('li[role="treeitem"]');if(!s)return;this.#g(s);let r=e.closest("a");r&&this.dispatchEvent(new CustomEvent("site-map-wc:select",{bubbles:!0,detail:{href:r.getAttribute("href")||"",pageType:s.getAttribute("data-page-type")||"page",template:s.getAttribute("data-template")||""}}))}#x(t){let e=t.target.closest('li[role="treeitem"]');if(!e)return;let s=t.key,r=!1;switch(s){case"ArrowDown":r=!0,this.#b(e);break;case"ArrowUp":r=!0,this.#w(e);break;case"ArrowRight":if(r=!0,e.getAttribute("aria-expanded")==="false")this.#h(e);else if(e.getAttribute("aria-expanded")==="true"){let i=e.querySelector(':scope > ul > li[role="treeitem"]');i&&this.#g(i)}break;case"ArrowLeft":if(r=!0,e.getAttribute("aria-expanded")==="true")this.#h(e);else{let i=e.parentElement?.closest('li[role="treeitem"]');i&&this.#g(i)}break;case"Enter":r=!0,e.hasAttribute("aria-expanded")&&this.#h(e);break;case" ":r=!0;{let i=e.querySelector(":scope > .sm-node-content > a");i&&i.click()}break;case"Home":r=!0;{let i=this.querySelector('li[role="treeitem"]');i&&this.#g(i)}break;case"End":r=!0;{let i=this.#u();i.length&&this.#g(i[i.length-1])}break}r&&(t.preventDefault(),t.stopPropagation())}#u(){let t=[],e=r=>{if(!r)return;let i=[...r.querySelectorAll(':scope > li[role="treeitem"]')];for(let a of i)if(t.push(a),a.getAttribute("aria-expanded")==="true"){let o=a.querySelector(":scope > ul");o&&e(o)}},s=this.querySelector("nav > ul");return e(s),t}#b(t){let e=this.#u(),s=e.indexOf(t);s>=0&&s<e.length-1&&this.#g(e[s+1])}#w(t){let e=this.#u(),s=e.indexOf(t);s>0&&this.#g(e[s-1])}#g(t){this.#r&&this.#r.setAttribute("tabindex","-1"),t.setAttribute("tabindex","0"),t.focus(),this.#r=t}static#v="http://www.w3.org/2000/svg";static#m=150;static#k=70;static#A=30;static#_=50;static#C=20;static#D={layout:{stroke:"#8b5cf6",fill:"#f5f3ff",text:"#6d28d9"},section:{stroke:"#3b82f6",fill:"#eff6ff",text:"#1d4ed8"},dashboard:{stroke:"#22c55e",fill:"#f0fdf4",text:"#15803d"},page:{stroke:"#94a3b8",fill:"#f8fafc",text:"#475569"},modal:{stroke:"#f59e0b",fill:"#fffbeb",text:"#b45309"},redirect:{stroke:"#ef4444",fill:"#fef2f2",text:"#b91c1c"}};static#j={draft:"#94a3b8",ready:"#f59e0b",live:"#22c55e",deprecated:"#ef4444"};#P(t){let e=[];for(let s of t.querySelectorAll(":scope > li")){let r=s.querySelector(":scope > a"),i=s.querySelector(":scope > ul");e.push({label:r?.textContent?.trim()||s.firstChild?.textContent?.trim()||"",href:r?.getAttribute("href")||"",pageType:s.getAttribute("data-page-type")||"page",template:s.getAttribute("data-template")||"",status:s.getAttribute("data-status")||"",children:i?this.#P(i):[],x:0,y:0,subtreeWidth:0,collapsed:!1,childCount:0})}return e}#R(t,e=0){let s=c.#m,r=c.#k,i=c.#A,a=c.#_;for(let o of t)o.childCount=this.#B(o),o.children.length>0&&!o.collapsed?(this.#R(o.children,e+1),o.subtreeWidth=o.children.reduce((n,d)=>n+d.subtreeWidth,0)+i*(o.children.length-1)):o.subtreeWidth=s,o.subtreeWidth=Math.max(o.subtreeWidth,s)}#B(t){let e=0;for(let s of t.children)e+=1+this.#B(s);return e}#F(t,e,s){let r=c.#m,i=c.#k,a=c.#A,o=c.#_,n=e;for(let d of t)d.x=n+(d.subtreeWidth-r)/2,d.y=s,d.children.length>0&&!d.collapsed&&this.#F(d.children,n,s+i+o),n+=d.subtreeWidth+a}#Z(t){t.style.display="none",t.setAttribute("aria-hidden","true");let e=t.querySelector("ul");e&&(this.#y=this.#P(e),this.#$())}#y=null;#E=1;get#M(){return this.dataset.orientation==="horizontal"?"horizontal":"vertical"}get#H(){return Math.min(4,Math.max(0,parseInt(this.dataset.detail||"2",10)))}static#T={zoomIn:'<circle cx="11" cy="11" r="8"/><line x1="21" x2="16.65" y1="21" y2="16.65"/><line x1="11" x2="11" y1="8" y2="14"/><line x1="8" x2="14" y1="11" y2="11"/>',zoomOut:'<circle cx="11" cy="11" r="8"/><line x1="21" x2="16.65" y1="21" y2="16.65"/><line x1="8" x2="14" y1="11" y2="11"/>',reset:'<path d="M15 3h6v6"/><path d="m21 3-7 7"/><path d="m3 21 7-7"/><path d="M9 21H3v-6"/>',flip:'<path d="M21 8V5a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v3"/><path d="M21 16v3a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-3"/><path d="M4 12H2"/><path d="M10 12H8"/><path d="M16 12h-2"/><path d="M22 12h-2"/>'};static#O=["Shape","Shape + Title","Full","Full + Status","Wireframe"];static#tt=0;#et(t){let e=this.#i?.querySelector(".sm-visual-scroll"),s=this.#i?.querySelector('svg[role="tree"]'),r={nodeId:null,rectTop:0,rectLeft:0,focusId:this.#q};if(!e||!s)return r;let i=t||this.#q;if(!i)return r;let o=s.querySelector(`[data-node-id="${i}"]`)?.querySelector("rect");if(!o)return r;let n=o.getBoundingClientRect(),d=e.getBoundingClientRect();return r.nodeId=i,r.rectTop=n.top-d.top,r.rectLeft=n.left-d.left,r}#U(t){let e=this.#i?.querySelector(".sm-visual-scroll"),s=this.#i?.querySelector('svg[role="tree"]');if(!(!e||!s)){if(t.nodeId){let i=s.querySelector(`[data-node-id="${t.nodeId}"]`)?.querySelector("rect");if(i){let a=i.getBoundingClientRect(),o=e.getBoundingClientRect(),n=a.top-o.top-t.rectTop,d=a.left-o.left-t.rectLeft;e.scrollTop+=n,e.scrollLeft+=d}}t.focusId&&(this.#S(t.focusId),s.focus({preventScroll:!0}))}}#$(t={}){if(!this.#y)return;let e=this.#et(t.anchorId||null),s=this.#i,r=c.#v,i=c.#m,a=c.#k,o=c.#C,n=this.#M==="horizontal";this.#R(this.#y),this.#F(this.#y,o,o);let d=this.#Q(this.#y),l=d.maxX+i+o,h=d.maxY+a+o;n&&([l,h]=[h,l]),this.#i=document.createElement("div"),this.#i.className="sm-visual",this.#i.setAttribute("tabindex","-1"),this.#i.appendChild(this.#st());let u=document.createElement("div");u.className="sm-visual-scroll";let m=document.createElementNS(r,"svg");m.setAttribute("viewBox",`0 0 ${l} ${h}`),m.setAttribute("width",String(l)),m.setAttribute("height",String(h)),m.setAttribute("role","img"),m.setAttribute("aria-label",`Site map${this.getAttribute("title")?": "+this.getAttribute("title"):""}`);let b=document.createElement("div");if(b.className="sm-visual-zoom",b.style.width=`${Math.round(l*this.#E)}px`,b.style.height=`${Math.round(h*this.#E)}px`,m.style.transform=`scale(${this.#E})`,m.style.transformOrigin="0 0",n){let y=document.createElementNS(r,"g");y.setAttribute("transform",`rotate(90 0 0) translate(0 -${h})`),this.#L(y,this.#y),this.#z(y,this.#y),m.appendChild(y)}else this.#L(m,this.#y),this.#z(m,this.#y);b.appendChild(m),u.appendChild(b),this.#i.appendChild(u);let p=document.createElement("div");p.className="sm-visual-summary";let g=Math.round(this.#E*100);p.textContent=`${this.#o} pages \xB7 ${this.#a} levels \xB7 ${g}%`,this.#i.appendChild(p);let v=this.#i,w=()=>{s&&s.isConnected?s.replaceWith(v):this.appendChild(v)};if(s?.isConnected&&"startViewTransition"in document&&!matchMedia("(prefers-reduced-motion: reduce)").matches){let y=`sm-vt-${++c.#tt}`;s.style.viewTransitionName=y,v.style.viewTransitionName=y;let _=document.startViewTransition(w);_.finished.finally(()=>{v.style.viewTransitionName=""}),_.updateCallbackDone.then(()=>this.#U(e))}else w(),this.#U(e);this.#ot(this.#i,m),this.listen(m,"click",y=>{let _=y.target,S=_.closest("[data-toggle]");if(S){let M=S.getAttribute("data-toggle");this.#K(M);return}let E=_.closest("[data-node-id]");E&&(this.#S(E.getAttribute("data-node-id")),this.dispatchEvent(new CustomEvent("site-map-wc:select",{bubbles:!0,detail:{href:E.getAttribute("data-href")||"",pageType:E.getAttribute("data-page-type")||"page",template:E.getAttribute("data-template")||""}})))}),m.setAttribute("tabindex","0"),m.setAttribute("role","tree"),m.setAttribute("aria-label",`Site map${this.getAttribute("title")?": "+this.getAttribute("title"):""} \u2014 use arrow keys to navigate`),m.addEventListener("keydown",y=>this.#it(y)),requestAnimationFrame(()=>{let y=m.querySelector("[data-node-id]");y&&this.#Y(y)})}#st(){let t=document.createElement("div");t.className="sm-vtoolbar",t.setAttribute("role","toolbar"),t.setAttribute("aria-label","Site map controls");let e=m=>`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">${m}</svg>`,s=this.#N(e(c.#T.zoomIn),"Zoom in",()=>{this.#E=Math.min(3,this.#E+.25),this.#$()});t.appendChild(s);let r=this.#N(e(c.#T.zoomOut),"Zoom out",()=>{this.#E=Math.max(.25,this.#E-.25),this.#$()});t.appendChild(r);let i=this.#N(e(c.#T.reset),"Reset zoom",()=>{this.#E=1,this.#$()});t.appendChild(i);let a=document.createElement("span");a.className="sm-vtoolbar-sep",t.appendChild(a);let o=this.#M==="horizontal"?"Vertical":"Horizontal",n=this.#N(e(c.#T.flip),o,()=>{this.dataset.orientation=this.#M==="horizontal"?"vertical":"horizontal",this.#$()});t.appendChild(n),t.appendChild(a.cloneNode());let d=this.#H,l=document.createElement("label");l.className="sm-vtoolbar-detail",l.textContent="Detail ";let h=document.createElement("input");h.type="range",h.min="0",h.max="4",h.value=String(d),h.setAttribute("aria-label","Detail level"),h.className="sm-vtoolbar-slider",l.appendChild(h);let u=document.createElement("span");return u.className="sm-vtoolbar-detail-label",u.textContent=c.#O[d],l.appendChild(u),h.addEventListener("input",()=>{this.dataset.detail=h.value,u.textContent=c.#O[parseInt(h.value,10)],this.#$()}),t.appendChild(l),t}#N(t,e,s){let r=document.createElement("button");return r.type="button",r.className="sm-vtoolbar-btn",r.innerHTML=t,r.setAttribute("aria-label",e),r.setAttribute("title",e),r.addEventListener("click",s),r}#q=null;#V(t,e=""){let s=[];for(let r=0;r<t.length;r++){let i=t[r],a=e?`${e}-${r}`:String(r);s.push(a),i.children.length>0&&!i.collapsed&&s.push(...this.#V(i.children,a))}return s}#rt(t){let e=t.lastIndexOf("-");return e>0?t.slice(0,e):null}#nt(t){let e=this.#I(t,this.#y);return!e||e.collapsed||e.children.length===0?null:`${t}-0`}#S(t){if(!t||!this.#i)return;let e=this.#i.querySelector('svg[role="tree"]');if(!e)return;let s=e.querySelector(`[data-node-id="${t}"]`);if(!s)return;this.#Y(s),this.#q=t;let r=s.querySelector("rect"),i=this.#i?.querySelector(".sm-visual-scroll");if(r&&i){let a=r.getBoundingClientRect(),o=i.getBoundingClientRect();(a.left<o.left||a.right>o.right||a.top<o.top||a.bottom>o.bottom)&&r.scrollIntoView({behavior:"smooth",block:"nearest",inline:"nearest"})}}#Y(t){let e=t.closest("svg");if(!e)return;e.querySelectorAll(".sm-vfocus-ring").forEach(i=>i.remove()),e.querySelectorAll("[data-node-id]").forEach(i=>i.removeAttribute("aria-current"));let s=c.#v,r=t.querySelector("rect");if(r){let i=document.createElementNS(s,"rect");i.setAttribute("x",String(parseFloat(r.getAttribute("x"))-3)),i.setAttribute("y",String(parseFloat(r.getAttribute("y"))-3)),i.setAttribute("width",String(parseFloat(r.getAttribute("width"))+6)),i.setAttribute("height",String(parseFloat(r.getAttribute("height"))+6)),i.setAttribute("rx","11"),i.setAttribute("fill","none"),i.setAttribute("stroke","#3b82f6"),i.setAttribute("stroke-width","2"),i.setAttribute("class","sm-vfocus-ring"),t.parentNode.insertBefore(i,t)}t.setAttribute("aria-current","true"),this.#q=t.getAttribute("data-node-id")}#it(t){if(!this.#y)return;let e=this.#q||"0",s=!1;switch(t.key){case"ArrowDown":{s=!0;let r=this.#I(e,this.#y);r&&r.children.length>0&&!r.collapsed&&this.#S(`${e}-0`);break}case"ArrowUp":{s=!0;let r=this.#rt(e);r&&this.#S(r);break}case"ArrowRight":{s=!0;let r=this.#W(e,1);r&&this.#S(r);break}case"ArrowLeft":{s=!0;let r=this.#W(e,-1);r&&this.#S(r);break}case"Enter":case" ":{s=!0;let r=this.#I(e,this.#y);r&&r.children.length>0&&this.#K(e);break}case"Home":{s=!0,this.#S("0");break}case"End":{s=!0;let r=this.#V(this.#y);r.length&&this.#S(r[r.length-1]);break}}s&&(t.preventDefault(),t.stopPropagation())}#W(t,e){let s=t.split("-").map(Number),r=s[s.length-1]+e;if(r<0)return null;let i=s.length>1?s.slice(0,-1).join("-"):null,a=i?this.#I(i,this.#y):null,o=a?a.children:this.#y;if(!o||r>=o.length)return null;let n=[...s];return n[n.length-1]=r,n.join("-")}#X=!1;#at={dragging:!1,startX:0,startY:0,scrollLeft:0,scrollTop:0,moved:!1};#ot(t,e){if(e.style.cursor="grab",this.#X)return;this.#X=!0;let s=this.#at;this.listen(this,"pointerdown",r=>{if(r.target.closest("button, [data-toggle], .sm-vtoolbar, input"))return;let i=this.querySelector(".sm-visual-scroll");if(!i)return;s.dragging=!0,s.moved=!1,s.startX=r.clientX,s.startY=r.clientY,s.scrollLeft=i.scrollLeft,s.scrollTop=i.scrollTop;let a=this.querySelector('svg[role="tree"]');a&&(a.style.cursor="grabbing")}),this.listen(window,"pointermove",r=>{if(!s.dragging)return;let i=r.clientX-s.startX,a=r.clientY-s.startY;(Math.abs(i)>3||Math.abs(a)>3)&&(s.moved=!0);let o=this.querySelector(".sm-visual-scroll");o&&(o.scrollLeft=s.scrollLeft-i,o.scrollTop=s.scrollTop-a)}),this.listen(window,"pointerup",()=>{if(!s.dragging)return;s.dragging=!1;let r=this.querySelector('svg[role="tree"]');r&&(r.style.cursor="grab")}),this.listen(this,"click",r=>{s.moved&&(r.stopPropagation(),s.moved=!1)},{capture:!0})}#Q(t){let e=0,s=0;for(let r of t)if(r.x+c.#m>e&&(e=r.x+c.#m),r.y+c.#k>s&&(s=r.y+c.#k),r.children.length>0&&!r.collapsed){let i=this.#Q(r.children);i.maxX>e&&(e=i.maxX),i.maxY>s&&(s=i.maxY)}return{maxX:e,maxY:s}}#L(t,e){let s=c.#v,r=c.#m,i=c.#k,a=c.#_;for(let o of e){if(o.children.length===0||o.collapsed)continue;let n=o.x+r/2,d=o.y+i,l=d+a/2;for(let h of o.children){let u=h.x+r/2,m=h.y,b=document.createElementNS(s,"path");b.setAttribute("d",`M ${n} ${d} L ${n} ${l} L ${u} ${l} L ${u} ${m}`),b.setAttribute("fill","none"),b.setAttribute("stroke","#cbd5e1"),b.setAttribute("stroke-width","1.5"),t.appendChild(b)}this.#L(t,o.children)}}#z(t,e,s=""){let r=c.#v,i=c.#m,a=c.#k,o=this.#H,n=o>=4;for(let d=0;d<e.length;d++){let l=e[d],h=s?`${s}-${d}`:String(d),u=n?{stroke:"#94a3b8",fill:"#ffffff",text:"#475569"}:c.#D[l.pageType]||c.#D.page,m=document.createElementNS(r,"g");m.setAttribute("data-node-id",h),m.setAttribute("data-href",l.href),m.setAttribute("data-page-type",l.pageType),m.setAttribute("data-template",l.template),m.style.cursor="pointer";let b=document.createElementNS(r,"rect");if(b.setAttribute("x",String(l.x)),b.setAttribute("y",String(l.y)),b.setAttribute("width",String(i)),b.setAttribute("height",String(a)),b.setAttribute("rx","8"),b.setAttribute("fill",u.fill),b.setAttribute("stroke",u.stroke),b.setAttribute("stroke-width",n?"1":"2"),(n||l.pageType==="modal")&&b.setAttribute("stroke-dasharray","6 3"),m.appendChild(b),o>=1){let p=document.createElementNS(r,"text");p.setAttribute("x",String(l.x+i/2)),p.setAttribute("y",String(o===1?l.y+a/2+5:l.y+24)),p.setAttribute("text-anchor","middle"),p.setAttribute("font-size","13"),p.setAttribute("font-weight","600"),p.setAttribute("fill",u.text),p.setAttribute("font-family","system-ui, sans-serif"),p.textContent=l.label.length>18?l.label.slice(0,17)+"\u2026":l.label,m.appendChild(p)}if(o>=2){let p=document.createElementNS(r,"text");if(p.setAttribute("x",String(l.x+i/2)),p.setAttribute("y",String(l.y+40)),p.setAttribute("text-anchor","middle"),p.setAttribute("font-size","9"),p.setAttribute("font-weight","700"),p.setAttribute("fill",u.stroke),p.setAttribute("font-family","system-ui, sans-serif"),p.textContent=(J[l.pageType]?.label||l.pageType).toUpperCase(),m.appendChild(p),l.template){let g=document.createElementNS(r,"text");g.setAttribute("x",String(l.x+i/2)),g.setAttribute("y",String(l.y+54)),g.setAttribute("text-anchor","middle"),g.setAttribute("font-size","9"),g.setAttribute("fill","#94a3b8"),g.setAttribute("font-family","system-ui, sans-serif"),g.textContent=l.template,m.appendChild(g)}}if(o>=3&&l.status&&c.#j[l.status]){let p=document.createElementNS(r,"circle");p.setAttribute("cx",String(l.x+i/2)),p.setAttribute("cy",String(l.y+a-8)),p.setAttribute("r","4"),p.setAttribute("fill",n?"#94a3b8":c.#j[l.status]),m.appendChild(p)}if(n)for(let p=0;p<2;p++){let g=document.createElementNS(r,"line");g.setAttribute("x1",String(l.x+12)),g.setAttribute("x2",String(l.x+i-12)),g.setAttribute("y1",String(l.y+a-22+p*8)),g.setAttribute("y2",String(l.y+a-22+p*8)),g.setAttribute("stroke","#cbd5e1"),g.setAttribute("stroke-width","1"),g.setAttribute("stroke-dasharray","3 2"),m.appendChild(g)}if(l.children.length>0){let p=document.createElementNS(r,"g");p.setAttribute("data-toggle",h),p.style.cursor="pointer";let g=document.createElementNS(r,"circle");g.setAttribute("cx",String(l.x+i/2)),g.setAttribute("cy",String(l.y+a+10)),g.setAttribute("r","10"),g.setAttribute("fill",n?"#fff":"#f1f5f9"),g.setAttribute("stroke","#cbd5e1"),g.setAttribute("stroke-width","1"),p.appendChild(g);let v=document.createElementNS(r,"text");v.setAttribute("x",String(l.x+i/2)),v.setAttribute("y",String(l.y+a+14)),v.setAttribute("text-anchor","middle"),v.setAttribute("font-size","11"),v.setAttribute("font-weight","700"),v.setAttribute("fill","#64748b"),v.setAttribute("font-family","system-ui, sans-serif"),v.textContent=l.collapsed?`+${l.childCount}`:"\u2212",p.appendChild(v),m.appendChild(p)}t.appendChild(m),l.children.length>0&&!l.collapsed&&this.#z(t,l.children,h)}}#K(t){let e=this.#I(t,this.#y);e&&(e.collapsed=!e.collapsed,this.#q||(this.#q=t),this.#$({anchorId:t}))}#I(t,e){if(!e)return null;let s=t.split("-").map(Number),r=e,i=null;for(let a of s){if(!r||a>=r.length)return null;i=r[a],r=i.children}return i}async _loadSrc(t){if(t)try{let e=await fetch(t);if(!e.ok)throw new Error(`HTTP ${e.status}`);let s=await e.json();s.title&&!this.getAttribute("title")&&this.setAttribute("title",s.title),this._setPages(s.pages||[])}catch(e){console.warn(`[site-map-wc] Failed to load src="${t}":`,e)}}get pages(){let e=this.querySelector(":scope > nav")?.querySelector("ul");return e?this.#G(e):[]}set pages(t){this._setPages(Array.isArray(t)?t:[]),this.dispatchEvent(new CustomEvent("site-map-wc:pages-changed",{detail:{pages:this.pages,source:"property"},bubbles:!0}))}_setPages(t){for(;this.firstChild;)this.firstChild.remove();let e=document.createElement("nav"),s=document.createElement("ul");this.#J(s,t),e.appendChild(s),this.appendChild(e),this.teardown(),this.removeAttribute("data-upgraded"),this.setup()}#G(t){let e=[];for(let s of t.querySelectorAll(":scope > li")){let r=s.querySelector(":scope > a"),i=s.querySelector(":scope > ul"),a={label:r?.textContent?.trim()||"",href:r?.getAttribute("href")||void 0,pageType:s.getAttribute("data-page-type")||void 0,template:s.getAttribute("data-template")||void 0,status:s.getAttribute("data-status")||void 0};i&&(a.children=this.#G(i)),e.push(a)}return e}#J(t,e){for(let s of e){let r=document.createElement("li");s.pageType&&r.setAttribute("data-page-type",s.pageType),s.template&&r.setAttribute("data-template",s.template),s.status&&r.setAttribute("data-status",s.status);let i=document.createElement("a");if(i.href=s.href||"#",i.textContent=s.label||"",r.appendChild(i),s.children&&s.children.length>0){let a=document.createElement("ul");this.#J(a,s.children),r.appendChild(a)}t.appendChild(r)}}};x("site-map-wc",kt);var F=`
:host {
...
`;var Bt={proposed:{label:"Proposed",color:"#3b82f6",bg:"rgba(59, 130, 246, 0.1)"},accepted:{label:"Accepted",color:"#22c55e",bg:"rgba(34, 197, 94, 0.1)"},deprecated:{label:"Deprecated",color:"#f59e0b",bg:"rgba(245, 158, 11, 0.1)"},superseded:{label:"Superseded",color:"#6b7280",bg:"rgba(107, 114, 128, 0.1)"}},j={calendar:'<rect width="18" height="18" x="3" y="4" rx="2" ry="2"/><line x1="16" x2="16" y1="2" y2="6"/><line x1="8" x2="8" y1="2" y2="6"/><line x1="3" x2="21" y1="10" y2="10"/>',context:'<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" x2="8" y1="13" y2="13"/><line x1="16" x2="8" y1="17" y2="17"/><line x1="10" x2="8" y1="9" y2="9"/>',decision:'<path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><path d="m9 11 3 3L22 4"/>',consequences:'<path d="m16 16 3-8 3 8c-.87.65-1.92 1-3 1s-2.13-.35-3-1Z"/><path d="m2 16 3-8 3 8c-.87.65-1.92 1-3 1s-2.13-.35-3-1Z"/><path d="M7 21h10"/><path d="M12 3v18"/><path d="M3 7h2c2 0 5-1 7-2 2 1 5 2 7 2h2"/>',arrowRight:'<path d="M5 12h14"/><path d="m12 5 7 7-7 7"/>'},Et=class extends HTMLElement{static get observedAttributes(){return["adr-id","status","supersedes","superseded-by","detail","compact","src"]}#e=new Map;constructor(){super(),this.attachShadow({mode:"open"})}#t(){for(let t of[...this.children]){let e=t.getAttribute("slot");e&&this.#e.set(e,t.textContent.trim())}}connectedCallback(){this.#t(),this.adrId&&!this.id&&(this.id=this.adrId),this.hasAttribute("src")&&this._loadSrc(this.getAttribute("src")),this.#s(),this.setAttribute("data-upgraded","")}disconnectedCallback(){this.removeAttribute("data-upgraded")}attributeChangedCallback(t,e,s){e!==s&&this.shadowRoot&&(t==="src"&&this.isConnected?this._loadSrc(s):this.#s())}get adrId(){return this.getAttribute("adr-id")||""}get status(){return this.getAttribute("status")||"proposed"}get adrTitle(){return this.querySelector('[slot="title"]')?.textContent?.trim()||this.#e.get("title")||""}get adrDate(){let t=this.querySelector('[slot="date"]');return t?.getAttribute("datetime")||t?.textContent?.trim()||this.#e.get("date")||""}get supersedes(){let t=this.getAttribute("supersedes")||"";return t?t.split(",").map(e=>e.trim()).filter(Boolean):[]}get supersededBy(){let t=this.getAttribute("superseded-by")||"";return t?t.split(",").map(e=>e.trim()).filter(Boolean):[]}get _detailLevel(){return this.getAttribute("detail")?this.getAttribute("detail"):this.hasAttribute("compact")?"compact":"full"}get _minimalLabel(){return this.adrTitle||this.adrId||"ADR"}get data(){return{adrId:this.adrId||void 0,status:this.status,detail:this.getAttribute("detail")||void 0,supersedes:this.supersedes.length?this.supersedes:void 0,supersededBy:this.supersededBy.length?this.supersededBy:void 0,title:this.adrTitle||void 0,date:this.adrDate||void 0}}set data(t){!t||typeof t!="object"||(this._applyData(t),this.#t(),this.shadowRoot&&this.#s(),this.dispatchEvent(new CustomEvent("adr-wc:data-changed",{detail:{data:this.data,source:"property"},bubbles:!0,composed:!0})))}_applyData(t){if(t.adrId!=null&&this.setAttribute("adr-id",String(t.adrId)),t.status!=null&&this.setAttribute("status",String(t.status)),t.detail!=null&&this.setAttribute("detail",String(t.detail)),t.supersedes&&this.setAttribute("supersedes",Array.isArray(t.supersedes)?t.supersedes.join(","):t.supersedes),t.supersededBy&&this.setAttribute("superseded-by",Array.isArray(t.supersededBy)?t.supersededBy.join(","):t.supersededBy),t.title&&!this.querySelector('[slot="title"]')){let e=document.createElement("h3");e.slot="title",e.textContent=t.title,this.appendChild(e)}if(t.date&&!this.querySelector('[slot="date"]')){let e=document.createElement("time");e.slot="date",e.setAttribute("datetime",t.date),e.textContent=new Date(t.date).toLocaleDateString(void 0,{year:"numeric",month:"long",day:"numeric"}),this.appendChild(e)}for(let e of["context","decision"])if(t[e]&&!this.querySelector(`[slot="${e}"]`)){let s=document.createElement("p");s.slot=e,s.textContent=t[e],this.appendChild(s)}if(t.consequences&&!this.querySelector('[slot="consequences"]')){let e=document.createElement("ul");e.slot="consequences";let s=Array.isArray(t.consequences)?t.consequences:[t.consequences];for(let r of s){let i=document.createElement("li");i.textContent=r,e.appendChild(i)}this.appendChild(e)}}async _loadSrc(t){if(t){this.shadowRoot.innerHTML=`<style>${F}</style><div class="state-msg">Loading\u2026</div>`;try{let e=await fetch(t);if(!e.ok)throw new Error(`HTTP ${e.status}`);let s=await e.json();this._applyData(s),this.#t(),this.#s()}catch(e){this.shadowRoot.innerHTML=`<style>${F}</style><div class="state-msg state-msg--error">Could not load: ${f(e.message)}</div>`}}}#s(){let t=Bt[this.status]||Bt.proposed,e=this._detailLevel,s=this.adrId?`ADR: ${f(this.adrId)}`:"Architectural Decision Record",r=!!this.querySelector('[slot="date"]')||this.#e.has("date");if(e==="minimal"){this.shadowRoot.innerHTML=`<style>${F}</style>
      ...
      </article>`,e==="compact")for(let i of this.shadowRoot.querySelectorAll(".adr-section")){let a=i.querySelector("slot");a&&a.assignedNodes().length===0&&i.setAttribute("data-empty","")}this.dispatchEvent(new CustomEvent("adr-wc:ready",{detail:{adrId:this.adrId,title:this.adrTitle,status:this.status},bubbles:!0,composed:!0}))}};x("adr-wc",Et);var St=class c extends C{static get observedAttributes(){return["src","title","compact"]}#e=null;#t=null;#s=null;#i=0;#r=[];setup(){let t=this.querySelector(":scope > ol");if(!t)return!1;let e=this.#n(t);if(e.length===0)return!1;this.#r=e,t.style.display="none",t.setAttribute("aria-hidden","true");let s=this.getAttribute("title");s&&(this.#t=document.createElement("h2"),this.#t.className="fd-title",this.#t.textContent=s,this.insertBefore(this.#t,t)),this.#e=document.createElement("div"),this.#e.className="fd-container",this.#e.setAttribute("role","img"),this.#e.setAttribute("aria-label",`Flow diagram${s?": "+s:""}`),this.#i=0,this.#c(e,this.#e);let r=document.createElement("div");r.className="fd-summary",r.textContent=`${this.#i} step${this.#i!==1?"s":""}`,this.#e.appendChild(r),this.insertBefore(this.#e,t),this.#s=document.createElement("div"),this.#s.className="fd-live",this.#s.setAttribute("role","status"),this.#s.setAttribute("aria-live","polite"),this.#s.setAttribute("aria-atomic","true"),this.appendChild(this.#s),this.listen(this.#e,"click",i=>{let a=i.target.closest(".fd-node-shape");if(!a)return;let n=a.closest(".fd-node")?.dataset.type||"action",d=a.textContent?.trim()||"";this.#f(`Selected: ${d}`),this.dispatchEvent(new CustomEvent("flow-diagram:select",{bubbles:!0,detail:{type:n,text:d}}))}),this.dispatchEvent(new CustomEvent("flow-diagram:ready",{bubbles:!0,detail:{nodeCount:this.#i}}))}teardown(){this.#t&&(this.#t.remove(),this.#t=null),this.#e&&(this.#e.remove(),this.#e=null),this.#s&&(this.#s.remove(),this.#s=null);let t=this.querySelector("ol");t&&(t.style.display="",t.removeAttribute("aria-hidden")),this.#i=0}static#o=0;attributeChangedCallback(t,e,s){e===s||!this.isConnected||(t==="src"?this._loadSrc(s):this.hasAttribute("data-upgraded")&&this.#a())}#a(){let t=()=>{this.teardown(),this.removeAttribute("data-upgraded"),this.setup()};if(this.hasAttribute("data-upgraded")&&"startViewTransition"in document&&!matchMedia("(prefers-reduced-motion: reduce)").matches){let e=`fd-vt-${++c.#o}`;this.style.viewTransitionName=e,document.startViewTransition(t).finished.finally(()=>{this.style.viewTransitionName=""})}else t()}get steps(){return this.#r}set steps(t){let e=Array.isArray(t)?t:[];this.#r=e,this.#t&&(this.#t.remove(),this.#t=null),this.#e&&(this.#e.remove(),this.#e=null),this.#s&&(this.#s.remove(),this.#s=null);let s=this.querySelector(":scope > ol");if(s||(s=document.createElement("ol"),s.style.display="none",s.setAttribute("aria-hidden","true"),this.appendChild(s)),e.length===0){this.dispatchEvent(new CustomEvent("flow-diagram:steps-changed",{detail:{steps:e,source:"property"},bubbles:!0}));return}let r=this.getAttribute("title");r&&(this.#t=document.createElement("h2"),this.#t.className="fd-title",this.#t.textContent=r,this.insertBefore(this.#t,s)),this.#e=document.createElement("div"),this.#e.className="fd-container",this.#e.setAttribute("role","img"),this.#e.setAttribute("aria-label",`Flow diagram${r?": "+r:""}`),this.#i=0,this.#c(e,this.#e);let i=document.createElement("div");i.className="fd-summary",i.textContent=`${this.#i} step${this.#i!==1?"s":""}`,this.#e.appendChild(i),this.insertBefore(this.#e,s),this.#s=document.createElement("div"),this.#s.className="fd-live",this.#s.setAttribute("role","status"),this.#s.setAttribute("aria-live","polite"),this.#s.setAttribute("aria-atomic","true"),this.appendChild(this.#s),this.dispatchEvent(new CustomEvent("flow-diagram:steps-changed",{detail:{steps:e,source:"property"},bubbles:!0}))}#n(t){let e=[];for(let s of t.querySelectorAll(":scope > li")){let r=this.#l(s);r&&e.push(r)}return e}#l(t){let e=t.dataset.type||"action",s=t.dataset.annotation||"",r=[],i=t.querySelectorAll(":scope > ol > li[data-branch]");if(i.length>0)for(let o of i){let n=o.dataset.branch||"",d=o.querySelector(":scope > ol"),l=d?this.#n(d):[];r.push({label:n,steps:l})}let a="";for(let o of t.childNodes)(o.nodeType===Node.TEXT_NODE||o.nodeType===Node.ELEMENT_NODE&&o.tagName!=="OL")&&(a+=o.textContent);return a=a.trim(),{type:e,text:a,annotation:s,branches:r}}#c(t,e){for(let s=0;s<t.length;s++){let r=t[s];s>0&&e.appendChild(this.#d());let i=this.#p(r);if(e.appendChild(i),r.branches.length>0){let a=document.createElement("div");a.className="fd-branches",a.setAttribute("data-branch-count",String(r.branches.length));let o=document.createElement("div");o.className="fd-split-line",o.setAttribute("aria-hidden","true"),a.appendChild(o);let n=document.createElement("div");n.className="fd-branch-columns";let d=(50/r.branches.length).toFixed(2);n.style.setProperty("--fd-inset",`${d}%`);for(let l of r.branches){let h=document.createElement("div");h.className="fd-branch",h.appendChild(this.#d());let u=document.createElement("span");u.className="fd-branch-label",u.textContent=l.label,u.setAttribute("data-branch",l.label.toLowerCase()),h.appendChild(u),this.#c(l.steps,h),n.appendChild(h)}a.appendChild(n),e.appendChild(a)}}}#p(t){this.#i++;let e=document.createElement("div");e.className="fd-node",e.dataset.type=t.type;let s=document.createElement("div");if(s.className="fd-node-shape",s.setAttribute("tabindex","0"),s.setAttribute("role","img"),s.setAttribute("aria-label",`${t.type}: ${t.text}`),s.textContent=t.text,e.appendChild(s),t.annotation){let r=document.createElement("div");r.className="fd-annotation",r.textContent=t.annotation,e.appendChild(r)}return e}#d(t){let e=document.createElement("div");e.className="fd-connector",e.setAttribute("aria-hidden","true");let s=document.createElement("div");if(s.className="fd-connector-line",e.appendChild(s),t){let i=document.createElement("span");i.className="fd-connector-label",i.textContent=t,e.appendChild(i)}let r=document.createElement("div");return r.className="fd-connector-arrow",e.appendChild(r),e}async _loadSrc(t){if(t)try{let e=await fetch(t);if(!e.ok)throw new Error(`HTTP ${e.status}`);let s=await e.json();for(;this.firstChild;)this.firstChild.remove();s.title&&this.setAttribute("title",s.title);let r=document.createElement("ol");this.#h(s.steps||[],r),this.appendChild(r),this.#a()}catch(e){console.warn(`[flow-diagram] Failed to load src="${t}":`,e)}}#h(t,e){for(let s of t){let r=document.createElement("li");if(s.type&&(r.dataset.type=s.type),s.annotation&&(r.dataset.annotation=s.annotation),r.textContent=s.text||"",s.branches&&s.branches.length>0){let i=document.createElement("ol");for(let a of s.branches){let o=document.createElement("li");o.dataset.branch=a.label||"";let n=document.createElement("ol");this.#h(a.steps||[],n),o.appendChild(n),i.appendChild(o)}r.appendChild(i)}e.appendChild(r)}}#f(t){this.#s&&(this.#s.textContent="",requestAnimationFrame(()=>{this.#s&&(this.#s.textContent=t)}))}};x("flow-diagram",St);function $(c,t,e){return c.getPropertyValue(t).trim()||e}function q(c,t){if(!t)return t;let e=document.createElement("span");e.style.color=t,e.style.position="absolute",e.style.visibility="hidden",e.style.pointerEvents="none",(c.parentElement||document.body).appendChild(e);let s=getComputedStyle(e).color;if(e.remove(),!s)return t;let r=q._canvas||(q._canvas=document.createElement("canvas"));r.width=r.height=1;let i=q._ctx||(q._ctx=r.getContext("2d",{willReadFrequently:!0}));i.clearRect(0,0,1,1),i.fillStyle=s,i.fillRect(0,0,1,1);let[a,o,n,d]=i.getImageData(0,0,1,1).data;return d===255?`rgb(${a},${o},${n})`:`rgba(${a},${o},${n},${(d/255).toFixed(3)})`}function oe(c){let t=getComputedStyle(c),e=q(c,$(t,"--color-text","#1a1a1a")),s=q(c,$(t,"--color-surface","#ffffff")),r=q(c,$(t,"--color-surface-raised",$(t,"--color-surface","#ffffff"))),i=q(c,$(t,"--color-border","#e0e0e0")),a=q(c,$(t,"--color-primary",$(t,"--color-interactive","#3b82f6"))),o=q(c,$(t,"--color-secondary",$(t,"--color-surface-raised","#f8f9fa"))),n=q(c,$(t,"--color-accent",$(t,"--color-primary","#3b82f6"))),d=q(c,$(t,"--color-text-muted",$(t,"--color-text","#1a1a1a"))),l=$(t,"--font-sans",'system-ui, -apple-system, "Segoe UI", sans-serif'),h=$(t,"--font-size-md","14px"),u=[a,n,o],m={};for(let p=0;p<12;p++)m[`cScale${p}`]=u[p%u.length],m[`cScaleLabel${p}`]=e,m[`cScalePeer${p}`]=i,m[`cScaleInv${p}`]=s;let b={};for(let p=0;p<8;p++)b[`git${p}`]=u[p%u.length],b[`gitInv${p}`]=s,b[`gitBranchLabel${p}`]=e;return{primaryColor:a,primaryBorderColor:i,primaryTextColor:e,nodeTextColor:e,secondaryColor:o,secondaryBorderColor:i,secondaryTextColor:e,tertiaryColor:n,tertiaryBorderColor:i,tertiaryTextColor:e,background:s,mainBkg:s,secondBkg:r,tertiaryBkg:r,lineColor:i,nodeBorder:i,gridColor:i,defaultLinkColor:d,clusterBkg:r,clusterBorder:i,actorBkg:s,actorBorder:i,actorTextColor:e,actorLineColor:i,signalColor:e,signalTextColor:e,labelBoxBkgColor:r,labelBoxBorderColor:i,labelTextColor:e,loopTextColor:e,noteBkgColor:r,noteBorderColor:i,noteTextColor:e,edgeLabelBackground:s,titleColor:e,fontFamily:l,fontSize:h,...m,...b}}function Ft(c,t={}){return{startOnLoad:!1,securityLevel:"strict",suppressErrorRendering:!0,theme:t.themeBase||"base",themeVariables:oe(c)}}var ne="https://cdn.jsdelivr.net/npm/mermaid@11.14.0/dist/mermaid.esm.min.mjs",Ht=new Map;function le(c){let t=c||typeof window<"u"&&window.VB_MERMAID_URL||ne,e=Ht.get(t);return e||(e=import(t).then(s=>s.default||s),Ht.set(t,e)),e}var $t=class c extends C{static#e=0;static#t=0;#s=null;#i=null;#r=null;#o=null;#a=null;#n=!1;setup(){this.hasAttribute("type")||this.setAttribute("type","mermaid");let t=this.getAttribute("min-height");t&&(this.style.minBlockSize=t);let e=this.querySelector(":scope > pre");e&&(this.#i=document.createElement("template"),this.#i.appendChild(e.cloneNode(!0)),this.#s=this.#h(e),this.setAttribute("data-rendering",""));let s=this.querySelector(":scope > .dwc-figure");s&&(this.#r=s,this.#n=!0,this.removeAttribute("data-rendering")),this.listen(window,"vb:theme-change",()=>{this.#a&&clearTimeout(this.#a),this.#a=setTimeout(()=>{this.#n&&this.#c()},50)});let r=this.getAttribute("src");r?this.#f(r).then(()=>this.#l()):this.#s&&this.#l()}teardown(){if(this.#o&&(this.#o.disconnect(),this.#o=null),this.#a&&(clearTimeout(this.#a),this.#a=null),this.#r&&(this.#r.remove(),this.#r=null),this.#i){let t=this.#i.content.firstElementChild;t&&!this.querySelector(":scope > pre")&&this.appendChild(t.cloneNode(!0))}this.#n=!1}#l(){if(this.getAttribute("loading")!=="lazy"){this.#c();return}if(!("IntersectionObserver"in window)){this.#c();return}this.#o=new IntersectionObserver(t=>{for(let e of t)if(e.isIntersecting){this.#o?.disconnect(),this.#o=null,this.#c();break}},{rootMargin:"200px"}),this.#o.observe(this)}async#c(){if(!this.#s)return;let t=this.getAttribute("type")||"mermaid";if(t!=="mermaid"){this.#d(new Error(`Unsupported diagram type "${t}". v1 supports "mermaid" only.`));return}try{let e=await le(this.dataset.mermaidSrc),s=Ft(this,{themeBase:this.dataset.themeBase||"base"});e.initialize(s);let r=`diagram-wc-${++c.#e}`,{svg:i}=await e.render(r,this.#s);this.#p(i),this.#n=!0,this.removeAttribute("data-rendering"),this.removeAttribute("data-error"),this.querySelector(":scope > .dwc-error")?.remove(),this.dispatchEvent(new CustomEvent("diagram-wc:ready",{bubbles:!0,detail:{svg:i,type:t,source:this.#s}}))}catch(e){this.removeAttribute("data-rendering"),this.#n||this.setAttribute("data-error",""),this.#d(e)}}#p(t){let e=document.createElement("figure");e.className="dwc-figure",e.setAttribute("role","img");let s=this.getAttribute("caption")||`${this.getAttribute("type")||"diagram"} diagram`;e.setAttribute("aria-label",s),e.innerHTML=t;let r=this.getAttribute("caption");if(r){let o=document.createElement("figcaption");o.className="dwc-caption",o.textContent=r,e.appendChild(o)}let i=this.#r,a=()=>{i&&i.isConnected?i.replaceWith(e):this.appendChild(e),this.querySelector(":scope > pre")?.remove(),this.#r=e};if(i?.isConnected&&"startViewTransition"in document&&!matchMedia("(prefers-reduced-motion: reduce)").matches){let o=`dwc-vt-${++c.#t}`;i.style.viewTransitionName=o,e.style.viewTransitionName=o,document.startViewTransition(a).finished.finally(()=>{e.style.viewTransitionName=""})}else a()}#d(t){if(!this.#n){if(!this.querySelector(":scope > pre")&&this.#i){let r=this.#i.content.firstElementChild;r&&this.appendChild(r.cloneNode(!0))}this.#r&&(this.#r.remove(),this.#r=null)}this.querySelector(":scope > .dwc-error")?.remove();let e=document.createElement("p");e.className="dwc-error",e.setAttribute("role","status");let s=(t.message||String(t)).split(`
`)[0].slice(0,240);e.textContent=`Diagram syntax error: ${s}`,this.appendChild(e),this.dispatchEvent(new CustomEvent("diagram-wc:error",{bubbles:!0,detail:{error:t,source:this.#s,type:this.getAttribute("type")}}))}#h(t){let e=t.querySelector("code");return(e?e.textContent:t.textContent)||""}async#f(t){try{let e=await fetch(t);if(!e.ok)throw new Error(`HTTP ${e.status}`);this.#s=await e.text()}catch(e){this.#d(e)}}get source(){return this.#s||""}set source(t){let e=String(t||"");e!==this.#s&&(this.#s=e,this.#r&&(this.#r.remove(),this.#r=null),this.querySelector(":scope > .dwc-error")?.remove(),this.dispatchEvent(new CustomEvent("diagram-wc:source-changed",{bubbles:!0,detail:{source:e}})),this.#c())}get svg(){return this.#r?.querySelector("svg")?.outerHTML||""}};x("diagram-wc",$t);
